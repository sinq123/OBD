...
// WriModpar_2.0Dlg.cpp : 实现文件
//

#include "stdafx.h"
#include "WriModpar_2.0.h"
#include "WriModpar_2.0Dlg.h"
...
// CWriModpar_20Dlg 对话框




CWriModpar_20Dlg::CWriModpar_20Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CWriModpar_20Dlg::IDD, pParent)
	, m_pchURL(NULL)
	, m_strURL(L"")
	, m_strStationNum(L"")
	, m_strLineNum(L"")
...
CWriModpar_20Dlg::~CWriModpar_20Dlg()
{
	// 删除字体
...
void CWriModpar_20Dlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CWriModpar_20Dlg, CDialogEx)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_TIMER()
	ON_WM_SIZE()
	ON_NOTIFY(NM_DBLCLK, IDC_LST_VEHICLE, &CWriModpar_20Dlg::OnLvnItemchangedLstVehicle)
	ON_NOTIFY(NM_DBLCLK, IDC_LST_PENDING, &CWriModpar_20Dlg::OnLvnItemchangedLstPending)
	ON_BN_CLICKED(IDC_BTN_UP_VEHICLE, &CWriModpar_20Dlg::OnBnClickedBtnUpVehicle)
	ON_BN_CLICKED(IDC_BTN_UP_PENDING, &CWriModpar_20Dlg::OnBnClickedBtnUpPending)
END_MESSAGE_MAP()


// CWriModpar_20Dlg 消息处理程序

BOOL CWriModpar_20Dlg::OnInitDialog()
{
...
//显示。
HCURSOR CWriModpar_20Dlg::OnQueryDragIcon()
{
...
void CWriModpar_20Dlg::OnTimer(UINT_PTR nIDEvent)
{
...
void CWriModpar_20Dlg::OnSize(UINT nType, int cx, int cy)
{
...
void CWriModpar_20Dlg::OnLvnItemchangedLstVehicle(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void CWriModpar_20Dlg::OnLvnItemchangedLstPending(NMHDR *pNMHDR, LRESULT *pResult)
{
	LPNMLISTVIEW pNMLV = reinterpret_cast<LPNMLISTVIEW>(pNMHDR);
	// TODO: 在此添加控件通知处理程序代码
	DetWhiModPar();
...
void CWriModpar_20Dlg::OnBnClickedBtnUpVehicle()
{
	// TODO: 在此添加控件通知处理程序代码
	GetIntVehList();
}
...
void CWriModpar_20Dlg::OnBnClickedBtnUpPending()
{
	// TODO: 在此添加控件通知处理程序代码
	GetPending();
}
...
void CWriModpar_20Dlg::InitCtrls(void)
{
	// 设置字体
	SetDlgFont();
...
void CWriModpar_20Dlg::SetDlgFont(void)
{
...
void CWriModpar_20Dlg::InitVehicleList(void)
{
...
void CWriModpar_20Dlg::GetLogFilePath(void)
{
	// 日志文件所在文件夹路径
...
void CWriModpar_20Dlg::GetConfig(void)
{
...
CString CWriModpar_20Dlg::DecodeURI(LPCSTR szURIString)
{
...
CString CWriModpar_20Dlg::DecodeURI(LPCWSTR szURIString)
{
	return DecodeURI(KUTF16ToANSI(szURIString));
}


void CWriModpar_20Dlg::GetIntVehList(void)
{
	// 安车
	...
	strXmlDoc.AppendFormat(L"<jkid>%s</jkid>", L"GetGas");
	...
	strXmlDoc.AppendFormat(L"<tsno>%s</tsno>", m_strStationNum);
	...
	nRet = CACHBIntLib_API::QueryObjectOut(m_pchURL, strXmlDoc.GetString(), strRetStr);
	if (nRet == 0)
	{
				...
				if (xmlReader.OpenNode(L"root/body/vehispara"))
				{
					...
					do
					{
						...
						do
						{
							...
							// 登录时间mdate
							if(L"mdate"==strNodeName)  
							{ 
								xmlReader.GetNodeContent(strContent); 
							}
							// 状态jcCarCheckStatus
							if(L"jcCarCheckStatus"==strNodeName)  
							{ 
								xmlReader.GetNodeContent(strContent); 
							}
						}
...
void CWriModpar_20Dlg::GetPending(void)
{
	CString strSql;
...
bool CWriModpar_20Dlg::SaveToDB(void)
{
...
bool CWriModpar_20Dlg::DetWhiModPar(void)
{
	CString strMsg;
