...
class CWriModpar_20Dlg : public CDialogEx
{
	// 构造
public:
	CWriModpar_20Dlg(CWnd* pParent = NULL);	// 标准构造函数
	virtual ~CWriModpar_20Dlg();
	// 对话框数据
	enum { IDD = IDD_WRIMODPAR_20_DIALOG };
