...
CSystemCheckDlg::CSystemCheckDlg(CWnd* pParent /*=NULL*/)
	: CDialogZoom(CSystemCheckDlg::IDD, pParent)
{
...
CSystemCheckDlg::~CSystemCheckDlg()
{
	m_fontDlgFont.DeleteObject();
}

void CSystemCheckDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CSystemCheckDlg, CDialogZoom)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BTN_DAILY_DEMARCATION, &CSystemCheckDlg::OnBnClickedBtnDailyDemarcation)
	ON_BN_CLICKED(IDC_BTN_EMISSION_TEST, &CSystemCheckDlg::OnBnClickedBtnEmissionTest)
	ON_BN_CLICKED(IDC_BTN_DATA_MANAGEMENT, &CSystemCheckDlg::OnBnClickedBtnDataManagement)
	ON_BN_CLICKED(IDC_BTN_SYSTEM_MANAGEMENT, &CSystemCheckDlg::OnBnClickedBtnSystemManagement)
	ON_BN_CLICKED(IDC_BTN_SYSTEM_CHECK, &CSystemCheckDlg::OnBnClickedBtnSystemCheck)
	ON_BN_CLICKED(IDC_BTN_TRAINING_PRESENTATION, &CSystemCheckDlg::OnBnClickedBtnTrainingPresentation)
	ON_BN_CLICKED(IDCANCEL, &CSystemCheckDlg::OnBnClickedCancel)
	ON_WM_TIMER()
END_MESSAGE_MAP()


// CSystemCheckDlg 消息处理程序

BOOL CSystemCheckDlg::OnInitDialog()
{
...
//显示。
HCURSOR CSystemCheckDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}

void CSystemCheckDlg::OnBnClickedBtnDailyDemarcation()
{
	CNHDailyDemarcationDlg dlg;
	const DWORD dwReturn = (DWORD)dlg.DoModal();
}

void CSystemCheckDlg::OnBnClickedBtnEmissionTest()
{
}

void CSystemCheckDlg::OnBnClickedBtnDataManagement()
{
}

void CSystemCheckDlg::OnBnClickedBtnSystemManagement()
{
}

void CSystemCheckDlg::OnBnClickedBtnSystemCheck()
{
}

void CSystemCheckDlg::OnBnClickedBtnTrainingPresentation()
{
}

void CSystemCheckDlg::OnBnClickedCancel()
{
	// 反初始化
...
void CSystemCheckDlg::InitCtrls(void)
{
	SetDlgFont();
...
void CSystemCheckDlg::SetDlgFont(void)
{
...
void CSystemCheckDlg::OnTimer(UINT_PTR nIDEvent)
{
