...
CCDSCheckDlg::CCDSCheckDlg(CWnd* pParent /*=NULL*/)
	: CDialogZoom(CCDSCheckDlg::IDD, pParent)
{
...
CCDSCheckDlg::~CCDSCheckDlg()
{
	m_fontDlgFont.DeleteObject();
}

void CCDSCheckDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CCDSCheckDlg, CDialogZoom)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BTN_DAILY_DEMARCATION, &CCDSCheckDlg::OnBnClickedBtnDailyDemarcation)
	ON_BN_CLICKED(IDC_BTN_EMISSION_TEST, &CCDSCheckDlg::OnBnClickedBtnEmissionTest)
	ON_BN_CLICKED(IDC_BTN_DATA_MANAGEMENT, &CCDSCheckDlg::OnBnClickedBtnDataManagement)
	ON_BN_CLICKED(IDC_BTN_SYSTEM_MANAGEMENT, &CCDSCheckDlg::OnBnClickedBtnSystemManagement)
	ON_BN_CLICKED(IDC_BTN_SYSTEM_CHECK, &CCDSCheckDlg::OnBnClickedBtnSystemCheck)
	ON_BN_CLICKED(IDC_BTN_TRAINING_PRESENTATION, &CCDSCheckDlg::OnBnClickedBtnTrainingPresentation)
	ON_BN_CLICKED(IDCANCEL, &CCDSCheckDlg::OnBnClickedCancel)
	ON_WM_TIMER()
END_MESSAGE_MAP()
...
BOOL CCDSCheckDlg::OnInitDialog()
{
...
//显示。
HCURSOR CCDSCheckDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}


void CCDSCheckDlg::OnBnClickedBtnDailyDemarcation()
{
...
void CCDSCheckDlg::OnBnClickedBtnSystemManagement()
{
}
...
void CCDSCheckDlg::OnBnClickedCancel()
{
	// 反初始化
	CNHEuqController::GetInstance().UnInit();
...
void CCDSCheckDlg::InitCtrls(void)
{
	SetDlgFont();
...
void CCDSCheckDlg::SetDlgFont(void)
{
...
void CCDSCheckDlg::OnTimer(UINT_PTR nIDEvent)
{
