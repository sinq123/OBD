...
class AFX_EXT_CLASS CSZInterfaceLib_API
{
public:
	CSZInterfaceLib_API(void);
	virtual ~CSZInterfaceLib_API(void);

private:
	CSZInterfaceLib_API(const CSZInterfaceLib_API &);
	CSZInterfaceLib_API & operator =(const CSZInterfaceLib_API &);
