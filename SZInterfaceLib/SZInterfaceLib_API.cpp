...
std::wstring CSZInterfaceLib_API::LogFilePath(void)
{
	// 日志文件所在文件夹路径
...
int CSZInterfaceLib_API::LoginServer(const char * pchURL, const std::wstring& strunitid, const std::wstring& strlineid, 
		const std::wstring& strusername, const std::wstring& pwd, std::wstring& strRetStr)
{
	...
	CNHLogAPI::WriteLogEx(CSZInterfaceLib_API::LogFilePath().c_str(), L"发送", L"", strLog);
	...
	if (nRet == SOAP_OK)
	{
		...
		CNHLogAPI::WriteLogEx(CSZInterfaceLib_API::LogFilePath().c_str(), L"接收", L"", strRetStr.c_str());
	}

	return nRet;
}

int CSZInterfaceLib_API::GetBaseTypeInfo(const char * pchURL, std::wstring& strRetStr)
{
	int nRet(999);
	IVehicleServiceServiceSoapBindingProxy toasb;
	soap_set_mode(&toasb, SOAP_C_UTFSTRING);
...
int CSZInterfaceLib_API::Vehiclelogin(const char * pchURL, const std::wstring& strXmlDoc, std::wstring& strRetStr)
{
	int nRet(999);
	IVehicleServiceServiceSoapBindingProxy toasb;
	soap_set_mode(&toasb, SOAP_C_UTFSTRING);
...
int CSZInterfaceLib_API::GetCheckList(const char * pchURL, const std::wstring& strtoken, const std::wstring& strunitid, std::wstring& strRetStr)
{
	int nRet(999);
	IVehicleServiceServiceSoapBindingProxy toasb;
	soap_set_mode(&toasb, SOAP_C_UTFSTRING);
...
int CSZInterfaceLib_API::getVehicle(const char * pchURL, const std::wstring& strtoken, const std::wstring& strunitid, const std::wstring& strVIN, std::wstring& strRetStr)
{
	int nRet(999);
	IVehicleServiceServiceSoapBindingProxy toasb;
	soap_set_mode(&toasb, SOAP_C_UTFSTRING);
...
int CSZInterfaceLib_API::BeginCheck(const char * pchURL, const std::wstring& strunitid, const std::wstring& strlineid,
...
int CSZInterfaceLib_API::UploadInspectionResult(const char * pchURL, const std::wstring& strtoken, const std::wstring& strunitid,
