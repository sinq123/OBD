...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.21 2020-11-05 08:05:06 GMT")
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE__ns1__query:
		...
		break;
	case SOAP_TYPE___ns1__write___:
		soap_serialize___ns1__write___(soap, (const struct __ns1__write___ *)ptr);
		break;
	case SOAP_TYPE___ns1__query___:
		soap_serialize___ns1__query___(soap, (const struct __ns1__query___ *)ptr);
		break;
	case SOAP_TYPE___ns1__write__:
		soap_serialize___ns1__write__(soap, (const struct __ns1__write__ *)ptr);
		break;
	case SOAP_TYPE___ns1__query__:
		soap_serialize___ns1__query__(soap, (const struct __ns1__query__ *)ptr);
		break;
...
{	(void)type;
	...
	case SOAP_TYPE___ns1__query__:
		return (void*)soap_instantiate___ns1__query__(soap, -1, type, arrayType, n);
	case SOAP_TYPE___ns1__write__:
		return (void*)soap_instantiate___ns1__write__(soap, -1, type, arrayType, n);
	case SOAP_TYPE___ns1__query___:
		return (void*)soap_instantiate___ns1__query___(soap, -1, type, arrayType, n);
	case SOAP_TYPE___ns1__write___:
		return (void*)soap_instantiate___ns1__write___(soap, -1, type, arrayType, n);
#ifndef WITH_NOGLOBAL
...
{	switch (p->type)
	...
	case SOAP_TYPE__ns1__write:
		if (p->size < 0)
			SOAP_DELETE((_ns1__write*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__write*)p->ptr);
		break;
	case SOAP_TYPE__ns1__writeResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__writeResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__writeResponse*)p->ptr);
		break;
	case SOAP_TYPE___ns1__query:
		if (p->size < 0)
	...
	case SOAP_TYPE___ns1__query__:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__query__*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__query__*)p->ptr);
		break;
	case SOAP_TYPE___ns1__write__:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__write__*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__write__*)p->ptr);
		break;
	case SOAP_TYPE___ns1__query___:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__query___*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__query___*)p->ptr);
		break;
	case SOAP_TYPE___ns1__write___:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__write___*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__write___*)p->ptr);
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
		if (p->size < 0)
...
{
	this->soap = soap;
	this->_ns1__writeResponse::writeResult = NULL;
...
void _ns1__writeResponse::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTostd__wstring(soap, &this->_ns1__writeResponse::writeResult);
	/* transient soap skipped */
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__writeResponse(struct soap *soap, const char *tag, int id, const _ns1__writeResponse *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__writeResponse), type))
		return soap->error;
	if (a->writeResult)
		soap_element_result(soap, "ns1:writeResult");
	if (soap_out_PointerTostd__wstring(soap, "ns1:writeResult", -1, &(a->_ns1__writeResponse::writeResult), ""))
		return soap->error;
	/* transient soap skipped */
...
SOAP_FMAC3 _ns1__writeResponse * SOAP_FMAC4 soap_in__ns1__writeResponse(struct soap *soap, const char *tag, _ns1__writeResponse *a, const char *type)
{
	...
	size_t soap_flag_writeResult1 = 1;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_writeResult1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__wstring(soap, "ns1:writeResult", &(a->_ns1__writeResponse::writeResult), "xsd:string"))
...
{
	register int id = soap_embed(soap, (void*)this, NULL, 0, SOAP_TYPE__ns1__writeResponse);
...
SOAP_FMAC1 _ns1__writeResponse * SOAP_FMAC2 soap_instantiate__ns1__writeResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__writeResponse);
		if (size)
			*size = sizeof(_ns1__writeResponse);
		((_ns1__writeResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__writeResponse, n);
		if (size)
...
void _ns1__write::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTostd__wstring(soap, &this->_ns1__write::xmlDoc);
	/* transient soap skipped */
#endif
}
...
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__write), type))
		return soap->error;
	if (soap_out_PointerTostd__wstring(soap, "ns1:xmlDoc", -1, &(a->_ns1__write::xmlDoc), ""))
		return soap->error;
	/* transient soap skipped */
	return soap_element_end_out(soap, tag);
}
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_xmlDoc1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__wstring(soap, "ns1:xmlDoc", &(a->_ns1__write::xmlDoc), "xsd:string"))
				{	soap_flag_xmlDoc1--;
					continue;
				}
			/* transient soap skipped */
...
{
	register int id = soap_embed(soap, (void*)this, NULL, 0, SOAP_TYPE__ns1__write);
...
SOAP_FMAC1 _ns1__write * SOAP_FMAC2 soap_instantiate__ns1__write(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__write);
		if (size)
			*size = sizeof(_ns1__write);
		((_ns1__write*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__write, n);
		if (size)
...
{
	this->soap = soap;
	this->_ns1__queryResponse::queryResult = NULL;
	/* transient soap skipped */
}
...
void _ns1__queryResponse::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTostd__wstring(soap, &this->_ns1__queryResponse::queryResult);
	/* transient soap skipped */
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__queryResponse(struct soap *soap, const char *tag, int id, const _ns1__queryResponse *a, const char *type)
{
	...
	if (soap_out_PointerTostd__wstring(soap, "ns1:queryResult", -1, &(a->_ns1__queryResponse::queryResult), ""))
		return soap->error;
	/* transient soap skipped */
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 _ns1__queryResponse * SOAP_FMAC4 soap_in__ns1__queryResponse(struct soap *soap, const char *tag, _ns1__queryResponse *a, const char *type)
{
	...
	size_t soap_flag_queryResult1 = 1;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_queryResult1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__wstring(soap, "ns1:queryResult", &(a->_ns1__queryResponse::queryResult), "xsd:string"))
...
{
	register int id = soap_embed(soap, (void*)this, NULL, 0, SOAP_TYPE__ns1__queryResponse);
...
void _ns1__query::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTostd__wstring(soap, &this->_ns1__query::xmlDoc);
	/* transient soap skipped */
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__query(struct soap *soap, const char *tag, int id, const _ns1__query *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__query), type))
		return soap->error;
	if (soap_out_PointerTostd__wstring(soap, "ns1:xmlDoc", -1, &(a->_ns1__query::xmlDoc), ""))
		return soap->error;
	/* transient soap skipped */
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 _ns1__query * SOAP_FMAC4 soap_in__ns1__query(struct soap *soap, const char *tag, _ns1__query *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_xmlDoc1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__wstring(soap, "ns1:xmlDoc", &(a->_ns1__query::xmlDoc), "xsd:string"))
				{	soap_flag_xmlDoc1--;
					continue;
				}
			/* transient soap skipped */
...
{
	register int id = soap_embed(soap, (void*)this, NULL, 0, SOAP_TYPE__ns1__query);
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__write___(struct soap *soap, struct __ns1__write___ *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->ns1__write = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__write___(struct soap *soap, const struct __ns1__write___ *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__write___(struct soap *soap, const char *tag, int id, const struct __ns1__write___ *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_out_PointerTo_ns1__write(soap, "ns1:write", -1, &a->ns1__write, ""))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__write___ * SOAP_FMAC4 soap_in___ns1__write___(struct soap *soap, const char *tag, struct __ns1__write___ *a, const char *type)
{
	size_t soap_flag_ns1__write = 1;
	short soap_flag;
	(void)tag; (void)type; /* appease -Wall -Werror */
	a = (struct __ns1__write___ *)soap_id_enter(soap, "", a, SOAP_TYPE___ns1__write___, sizeof(struct __ns1__write___), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___ns1__write___(soap, a);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__write___(struct soap *soap, const struct __ns1__write___ *a, const char *tag, const char *type)
{
	register int id = 0;
	if (soap_out___ns1__write___(soap, tag?tag:"-ns1:write", id, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__write___ * SOAP_FMAC4 soap_get___ns1__write___(struct soap *soap, struct __ns1__write___ *p, const char *tag, const char *type)
{
	if ((p = soap_in___ns1__write___(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct __ns1__write___ * SOAP_FMAC2 soap_instantiate___ns1__write___(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate___ns1__write___(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE___ns1__write___, n, soap_fdelete);
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__write___);
		if (size)
			*size = sizeof(struct __ns1__write___);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__write___, n);
		if (size)
			*size = n * sizeof(struct __ns1__write___);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct __ns1__write___*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__write___(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct __ns1__write___ %p -> %p\n", q, p));
	*(struct __ns1__write___*)p = *(struct __ns1__write___*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__query___(struct soap *soap, struct __ns1__query___ *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->ns1__query = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__query___(struct soap *soap, const struct __ns1__query___ *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__query___(struct soap *soap, const char *tag, int id, const struct __ns1__query___ *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
...
SOAP_FMAC3 struct __ns1__query___ * SOAP_FMAC4 soap_in___ns1__query___(struct soap *soap, const char *tag, struct __ns1__query___ *a, const char *type)
{
	size_t soap_flag_ns1__query = 1;
	short soap_flag;
	(void)tag; (void)type; /* appease -Wall -Werror */
	a = (struct __ns1__query___ *)soap_id_enter(soap, "", a, SOAP_TYPE___ns1__query___, sizeof(struct __ns1__query___), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___ns1__query___(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__query___(struct soap *soap, const struct __ns1__query___ *a, const char *tag, const char *type)
{
	register int id = 0;
	if (soap_out___ns1__query___(soap, tag?tag:"-ns1:query", id, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__query___ * SOAP_FMAC4 soap_get___ns1__query___(struct soap *soap, struct __ns1__query___ *p, const char *tag, const char *type)
{
	if ((p = soap_in___ns1__query___(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct __ns1__query___ * SOAP_FMAC2 soap_instantiate___ns1__query___(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate___ns1__query___(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE___ns1__query___, n, soap_fdelete);
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__query___);
		if (size)
			*size = sizeof(struct __ns1__query___);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__query___, n);
		if (size)
			*size = n * sizeof(struct __ns1__query___);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct __ns1__query___*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__query___(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct __ns1__query___ %p -> %p\n", q, p));
	*(struct __ns1__query___*)p = *(struct __ns1__query___*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__write__(struct soap *soap, struct __ns1__write__ *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->ns1__write = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__write__(struct soap *soap, const struct __ns1__write__ *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTo_ns1__write(soap, &a->ns1__write);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__write__(struct soap *soap, const char *tag, int id, const struct __ns1__write__ *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_out_PointerTo_ns1__write(soap, "ns1:write", -1, &a->ns1__write, ""))
		return soap->error;
...
SOAP_FMAC3 struct __ns1__write__ * SOAP_FMAC4 soap_in___ns1__write__(struct soap *soap, const char *tag, struct __ns1__write__ *a, const char *type)
{
	size_t soap_flag_ns1__write = 1;
	short soap_flag;
	(void)tag; (void)type; /* appease -Wall -Werror */
	a = (struct __ns1__write__ *)soap_id_enter(soap, "", a, SOAP_TYPE___ns1__write__, sizeof(struct __ns1__write__), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___ns1__write__(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_ns1__write && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTo_ns1__write(soap, "ns1:write", &a->ns1__write, ""))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__write__(struct soap *soap, const struct __ns1__write__ *a, const char *tag, const char *type)
{
	register int id = 0;
	if (soap_out___ns1__write__(soap, tag?tag:"-ns1:write", id, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__write__ * SOAP_FMAC4 soap_get___ns1__write__(struct soap *soap, struct __ns1__write__ *p, const char *tag, const char *type)
{
	if ((p = soap_in___ns1__write__(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct __ns1__write__ * SOAP_FMAC2 soap_instantiate___ns1__write__(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate___ns1__write__(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE___ns1__write__, n, soap_fdelete);
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__write__);
		if (size)
			*size = sizeof(struct __ns1__write__);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__write__, n);
		if (size)
			*size = n * sizeof(struct __ns1__write__);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct __ns1__write__*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__write__(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct __ns1__write__ %p -> %p\n", q, p));
	*(struct __ns1__write__*)p = *(struct __ns1__write__*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__query__(struct soap *soap, struct __ns1__query__ *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->ns1__query = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__query__(struct soap *soap, const struct __ns1__query__ *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTo_ns1__query(soap, &a->ns1__query);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__query__(struct soap *soap, const char *tag, int id, const struct __ns1__query__ *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_out_PointerTo_ns1__query(soap, "ns1:query", -1, &a->ns1__query, ""))
		return soap->error;
...
SOAP_FMAC3 struct __ns1__query__ * SOAP_FMAC4 soap_in___ns1__query__(struct soap *soap, const char *tag, struct __ns1__query__ *a, const char *type)
{
	size_t soap_flag_ns1__query = 1;
	short soap_flag;
	(void)tag; (void)type; /* appease -Wall -Werror */
	a = (struct __ns1__query__ *)soap_id_enter(soap, "", a, SOAP_TYPE___ns1__query__, sizeof(struct __ns1__query__), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___ns1__query__(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_ns1__query && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTo_ns1__query(soap, "ns1:query", &a->ns1__query, ""))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__query__(struct soap *soap, const struct __ns1__query__ *a, const char *tag, const char *type)
{
	register int id = 0;
	if (soap_out___ns1__query__(soap, tag?tag:"-ns1:query", id, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__query__ * SOAP_FMAC4 soap_get___ns1__query__(struct soap *soap, struct __ns1__query__ *p, const char *tag, const char *type)
{
	if ((p = soap_in___ns1__query__(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct __ns1__query__ * SOAP_FMAC2 soap_instantiate___ns1__query__(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate___ns1__query__(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE___ns1__query__, n, soap_fdelete);
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__query__);
		if (size)
			*size = sizeof(struct __ns1__query__);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__query__, n);
		if (size)
			*size = n * sizeof(struct __ns1__query__);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct __ns1__query__*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__query__(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct __ns1__query__ %p -> %p\n", q, p));
	*(struct __ns1__query__*)p = *(struct __ns1__query__*)q;
}
...
SOAP_FMAC3 _ns1__write ** SOAP_FMAC4 soap_in_PointerTo_ns1__write(struct soap *soap, const char *tag, _ns1__write **a, const char *type)
{
	...
	*a = NULL;
	...
	{	_ns1__write ** p = (_ns1__write **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__ns1__write, sizeof(_ns1__write), 0);
		a = p;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_PointerTo_ns1__write);
	if (soap_out_PointerTo_ns1__write(soap, tag?tag:"ns1:write", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_PointerTo_ns1__query);
