...
class CGasolineVehicleEquipmentPrepareNDlg : public CDialogZoom
{
	DECLARE_DYNAMIC(CGasolineVehicleEquipmentPrepareNDlg)

public:
	CGasolineVehicleEquipmentPrepareNDlg(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CGasolineVehicleEquipmentPrepareNDlg();
