...
BEGIN_MESSAGE_MAP(CSYDATAApp, CWinApp)
...
BOOL CSYDATAApp::InitInstance()
{
	HANDLE hMutex = CreateMutex(NULL, TRUE, m_pszAppName);
	if (ERROR_ALREADY_EXISTS == ::GetLastError())
	{
		MessageBox(NULL, L"程序已经运行", L"沈阳", MB_ICONWARNING|MB_OK);
		return FALSE;
	}
