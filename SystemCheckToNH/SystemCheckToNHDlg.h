...
class CSystemCheckToNHDlg : public CDialogZoom
{
// 构造
public:
	CSystemCheckToNHDlg(CWnd* pParent = NULL);	// 标准构造函数
	virtual ~CSystemCheckToNHDlg();
// 对话框数据
	enum { IDD = IDD_SYSTEMCHECKTONH_DIALOG };
