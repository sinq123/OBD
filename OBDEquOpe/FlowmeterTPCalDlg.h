...
* All rights reserved.
*
* 文件名称：FlowmeterTPCalibrationDlg.h
* 文件标识：
* 摘要：Sensor流量计VMAS温度校准
*
* 当前版本：1.0
* 作者：Cui
* 完成日期：2009-12-11
...
class CFlowmeterTPCalDlg : public CDialogZoom
{
	DECLARE_DYNAMIC(CFlowmeterTPCalDlg)

public:
	CFlowmeterTPCalDlg(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CFlowmeterTPCalDlg();

// 对话框数据
	enum { IDD = IDD_DIALOG_FLOWMETER_TP_CALIBRATION };
...
private:
	// 导出实时数据
	void ExportFloTPCalRTData(void);
	// 导出结果
