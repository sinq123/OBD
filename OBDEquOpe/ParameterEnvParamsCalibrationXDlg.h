...
* All rights reserved.
*
* 文件名称：ParameterEnvParamsCalibrationXDlg.h
* 文件标识：
...
class CParameterEnvParamsCalibrationXDlg : public CDialogZoom
{
	DECLARE_DYNAMIC(CParameterEnvParamsCalibrationXDlg)

public:
	CParameterEnvParamsCalibrationXDlg(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CParameterEnvParamsCalibrationXDlg();

// 对话框数据
	enum { IDD = IDD_PARAMETER_ENVPARAMS_CALIBRATION_XDLG };
...
protected:
	...
	afx_msg void OnBnClickedButtonOtLowCal();
	afx_msg void OnBnClickedButtonOtHighCal();
	afx_msg void OnBnClickedButtonEtZeroCal();
	afx_msg void OnBnClickedButtonRhZeroCal();
	afx_msg void OnBnClickedButtonApZeroCal();
	afx_msg void OnBnClickedButtonOtZeroCal();
