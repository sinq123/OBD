...
* All rights reserved.
*
* 文件名称：NHA503XGasCalibrationDlg.h
* 文件标识：
* 摘要：气体校准(不包括气体检查)
*
* 当前版本：1.0.10
...
// CNHA503XGasCalibrationDlg 对话框

class CNHA503XGasCalibrationDlg : public CDialogZoom
{
	DECLARE_DYNAMIC(CNHA503XGasCalibrationDlg)

public:
	CNHA503XGasCalibrationDlg(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CNHA503XGasCalibrationDlg();

// 对话框数据
	enum { IDD = IDD_NHA503XCALDLG };
...
protected:
	...
	afx_msg void OnBnClickedRadio4ChnCal();
	afx_msg void OnBnClickedRadio3ChnCal();
	afx_msg void OnBnClickedRadio1ChnCal();
...
private:
	...
	// 四通道校准按钮
	CButton m_rdo4ChnCal;
	// 三通道校准按钮
	CButton m_rdo3ChnCal;
	// 单通道校准按钮
	CButton m_rdo1ChnCal;
