...
class CNHCPLHPDlg : public CDialogZoom
{
	DECLARE_DYNAMIC(CNHCPLHPDlg)

public:
	CNHCPLHPDlg(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CNHCPLHPDlg();

// 对话框数据
	enum { IDD = IDD_DIALOG_NHC_PLHP };
...
private:
	// 测功机寄生功率控制线程
	CNHCPLHPThread *m_pNHCPLHPThread;
