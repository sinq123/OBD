...
#include "stdafx.h"
#include "NHCPLHPThread.h"


// CNHCPLHPThread

IMPLEMENT_DYNCREATE(CNHCPLHPThread, CDynThread)

CNHCPLHPThread::CNHCPLHPThread()
: m_unTimerRes(50)
...
BOOL CNHCPLHPThread::InitInstance()
{
	// TODO: 在此执行任意逐线程初始化
...
int CNHCPLHPThread::ExitInstance()
{
	// TODO: 在此执行任意逐线程清理
...
BEGIN_MESSAGE_MAP(CNHCPLHPThread, CDynThread)
	ON_THREAD_MESSAGE(WM_DYN_START_PLHP_TEST, OnStartPLHPTest)
END_MESSAGE_MAP()


// CNHCPLHPThread 消息处理程序

void CNHCPLHPThread::TimeProOfPLHP(UINT uID, UINT uMsg, DWORD dwUser, DWORD dw1, DWORD dw2)
{
	CNHCPLHPThread* pThread = (CNHCPLHPThread*)(dwUser);
	pThread->PLHPTest();
	//TRACE("PLHPTest is executed\n\n");
}

void CNHCPLHPThread::StartPLHPTest_Asyn(const enum PLHPType pt, const HWND hCallBackWnd)
{
	m_PLHPType = pt;
	if (PLHP_LUGDOWN == pt)
	{
...
void CNHCPLHPThread::OnStartPLHPTest(WPARAM wParam, LPARAM lParam)
{
	// 设状态为：就绪准备
...
void CNHCPLHPThread::StartPLHPTest(const enum PLHPType pt, const HWND hCallBackWnd)
{
	m_PLHPType = pt;
	if (PLHP_LUGDOWN == pt)
	{
...
void CNHCPLHPThread::StopPLHPTest(void)
{
	// 停止定时器
	if (NULL != m_unTimerIdOfPLHP)
	{
...
void CNHCPLHPThread::PLHPTest(void)
{
...
void CNHCPLHPThread::PLHPTestStep1(void)
{
	// 寄生功率步骤-准备就绪
...
void CNHCPLHPThread::PLHPTestStep2(void)
{
	// 寄生功率步骤-降举升器流程
...
void CNHCPLHPThread::PLHPTestStep3(void)
{
	// 寄生功率步骤-加速
...
void CNHCPLHPThread::PLHPTestStep4(void)
{
	//寄生功率步骤-滑行(计时)
...
//void CNHCPLHPThread::PLHPTestStep5(void)
//{
//	// 寄生功率步骤-滑行(等待滚筒停下来)
//
//	if (DYN_WR_SUCCEED != GetRealTimeData())
...
void CNHCPLHPThread::PLHPTestStep4_ASM(void)
{
	...
	case 0:
		{
			...
			// 启动秒表2(51~45)
			SetUpperVelocityOfTimer2(51);
			SetLowerVelocityOfTimer2(45);
			SetTimer2();
			// 启动秒表1(48~33~17)
...
void CNHCPLHPThread::PLHPTestStep4_VMAS(void)
{
	switch (m_unSlipState)
	{
	case 0:
...
void CNHCPLHPThread::PLHPTestStep4_LUGDOWN(void)
{
	switch (m_unSlipState)
	{
	case 0:
...
void CNHCPLHPThread::RemanenceRecord_ASM(void)
{
	// ASM剩磁记录
...
void CNHCPLHPThread::RemanenceRecord_VMAS(void)
{
	// VMAS剩磁记录
...
void CNHCPLHPThread::RemanenceRecord_LUGDOWN(void)
{
	// LUGDOWN剩磁记录
...
void CNHCPLHPThread::RemanenceRecordOfSection1(void)
{
	// 剩磁记录-功率模式
...
void CNHCPLHPThread::RemanenceRecordOfSection2(void)
{
	// 剩磁记录-功率模式
...
void CNHCPLHPThread::RemanenceRecordOfSection3(void)
{
	// 剩磁记录-功率模式
...
void CNHCPLHPThread::RemanenceRecordOfSection4(void)
{
	// 剩磁记录-功率模式
...
void CNHCPLHPThread::RemanenceRecordOfSection5(void)
{
	// 剩磁记录-功率模式
...
void CNHCPLHPThread::RemanenceRecordOfSection6(void)
{
	// 剩磁记录-功率模式
...
void CNHCPLHPThread::RemanenceRecordOfSection7(void)
{
	// 剩磁记录-功率模式
...
void CNHCPLHPThread::RemanenceRecordOfSection8(void)
{
	// 剩磁记录-功率模式
...
void CNHCPLHPThread::RemanenceRecordOfSection9(void)
{
	// 剩磁记录-功率模式
