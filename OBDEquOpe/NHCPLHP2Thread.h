...
class CNHCPLHP2Thread : public CDynThread
{
	DECLARE_DYNCREATE(CNHCPLHP2Thread)

protected:
	CNHCPLHP2Thread();           // 动态创建所使用的受保护的构造函数
	virtual ~CNHCPLHP2Thread();
...
private:
	...
	//void PLHPTestStep5(void);  // 滑行(等待滚筒停止)
