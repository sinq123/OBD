...
// YJSCheckDlg.cpp : 实现文件
//

#include "stdafx.h"
#include "YJSCheck.h"
#include "YJSCheckDlg.h"
...
CYJSCheckDlg::CYJSCheckDlg(CWnd* pParent /*=NULL*/)
	: CDialogZoom(CYJSCheckDlg::IDD, pParent)
{
...
CYJSCheckDlg::~CYJSCheckDlg()
{
	m_fontDlgFont.DeleteObject();
}

void CYJSCheckDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CYJSCheckDlg, CDialogZoom)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BTN_DAILY_DEMARCATION, &CYJSCheckDlg::OnBnClickedBtnDailyDemarcation)
	ON_BN_CLICKED(IDC_BTN_EMISSION_TEST, &CYJSCheckDlg::OnBnClickedBtnEmissionTest)
	ON_BN_CLICKED(IDC_BTN_DATA_MANAGEMENT, &CYJSCheckDlg::OnBnClickedBtnDataManagement)
	ON_BN_CLICKED(IDC_BTN_SYSTEM_MANAGEMENT, &CYJSCheckDlg::OnBnClickedBtnSystemManagement)
	ON_BN_CLICKED(IDC_BTN_SYSTEM_CHECK, &CYJSCheckDlg::OnBnClickedBtnSystemCheck)
	ON_BN_CLICKED(IDC_BTN_TRAINING_PRESENTATION, &CYJSCheckDlg::OnBnClickedBtnTrainingPresentation)
	ON_BN_CLICKED(IDCANCEL, &CYJSCheckDlg::OnBnClickedCancel)
	ON_WM_TIMER()
END_MESSAGE_MAP()
...
BOOL CYJSCheckDlg::OnInitDialog()
{
...
//显示。
HCURSOR CYJSCheckDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}


void CYJSCheckDlg::OnBnClickedBtnDailyDemarcation()
{
	CNHDailyDemarcationDlg dlg;
	const DWORD dwReturn = (DWORD)dlg.DoModal();
}

void CYJSCheckDlg::OnBnClickedBtnEmissionTest()
{
	//// 反初始化
...
void CYJSCheckDlg::OnBnClickedBtnDataManagement()
{
}

void CYJSCheckDlg::OnBnClickedBtnSystemManagement()
{
}

void CYJSCheckDlg::OnBnClickedBtnSystemCheck()
{
...
void CYJSCheckDlg::OnBnClickedBtnTrainingPresentation()
{
}

void CYJSCheckDlg::OnBnClickedCancel()
{
	// 反初始化
	CNHEuqController::GetInstance().UnInit();

	CSocketLib_API::GetInstance().CloseConnect();

	OnCancel();
}

void CYJSCheckDlg::InitCtrls(void)
{
	SetDlgFont();
...
void CYJSCheckDlg::SetDlgFont(void)
{
...
void CYJSCheckDlg::OnTimer(UINT_PTR nIDEvent)
{
