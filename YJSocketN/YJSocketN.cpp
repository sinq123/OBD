...
BEGIN_MESSAGE_MAP(CYJSocketNApp, CWinApp)
...
// 唯一的一个 CYJSocketNApp 对象

CYJSocketNApp theApp;


// CYJSocketNApp 初始化

BOOL CYJSocketNApp::InitInstance()
{
