...
public:
	virtual int soap_type() const { return 8; } /* = unique id SOAP_TYPE__ns1__query */
...
public:
	...
	struct soap *soap;	/* transient */
public:
	virtual int soap_type() const { return 9; } /* = unique id SOAP_TYPE__ns1__queryResponse */
	virtual void soap_default(struct soap*);
	virtual void soap_serialize(struct soap*) const;
	virtual int soap_put(struct soap*, const char*, const char*) const;
	virtual int soap_out(struct soap*, const char*, int, const char*) const;
...
public:
	...
	struct soap *soap;	/* transient */
public:
	virtual int soap_type() const { return 10; } /* = unique id SOAP_TYPE__ns1__write */
	virtual void soap_default(struct soap*);
	virtual void soap_serialize(struct soap*) const;
	virtual int soap_put(struct soap*, const char*, const char*) const;
	virtual int soap_out(struct soap*, const char*, int, const char*) const;
...
public:
	...
	struct soap *soap;	/* transient */
public:
	virtual int soap_type() const { return 11; } /* = unique id SOAP_TYPE__ns1__writeResponse */
	virtual void soap_default(struct soap*);
	virtual void soap_serialize(struct soap*) const;
	virtual int soap_put(struct soap*, const char*, const char*) const;
	virtual int soap_out(struct soap*, const char*, int, const char*) const;
...
public:
	int soap_type() const { return 18; } /* = unique id SOAP_TYPE___ns1__query */
};
#endif
...
public:
	int soap_type() const { return 22; } /* = unique id SOAP_TYPE___ns1__write */
};
#endif
...
public:
	_ns1__query *ns1__query;	/* optional element of type ns1:query */
public:
	int soap_type() const { return 24; } /* = unique id SOAP_TYPE___ns1__query_ */
};
#endif
...
public:
	_ns1__write *ns1__write;	/* optional element of type ns1:write */
public:
	int soap_type() const { return 26; } /* = unique id SOAP_TYPE___ns1__write_ */
};
#endif
