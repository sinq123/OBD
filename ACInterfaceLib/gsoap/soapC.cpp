...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.14 2019-11-07 02:46:43 GMT")
...
SOAP_FMAC3 _ns1__writeResponse ** SOAP_FMAC4 soap_in_PointerTo_ns1__writeResponse(struct soap *soap, const char *tag, _ns1__writeResponse **a, const char *type)
{
	...
	*a = NULL;
	...
	{	_ns1__writeResponse ** p = (_ns1__writeResponse **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__ns1__writeResponse, sizeof(_ns1__writeResponse), 0);
		a = p;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__writeResponse(struct soap *soap, _ns1__writeResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__writeResponse(soap, tag?tag:"ns1:writeResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
