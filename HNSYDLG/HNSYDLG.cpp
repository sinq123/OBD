...
BEGIN_MESSAGE_MAP(CHNSYDLGApp, CWinApp)
...
BOOL CHNSYDLGApp::InitInstance()
{
	HANDLE hMutex = CreateMutex(NULL, TRUE, m_pszAppName);
	if (ERROR_ALREADY_EXISTS == ::GetLastError())
	{
		MessageBox(NULL, L"程序已经运行", L"湖南邵阳", MB_ICONWARNING|MB_OK);
		return FALSE;
	}
