...
public:
	ns1__write *ns1__write_;	/* optional element of type ns1:write */
public:
	int soap_type() const { return 24; } /* = unique type id SOAP_TYPE___ns1__write_ */
};
#endif
...
public:
	ns1__query *ns1__query_;	/* optional element of type ns1:query */
public:
	int soap_type() const { return 26; } /* = unique type id SOAP_TYPE___ns1__query_ */
};
#endif
...
SOAP_FMAC5 int SOAP_FMAC6 __ns1__write(struct soap*, ns1__write *ns1__write_, ns1__writeResponse &ns1__writeResponse_);

SOAP_FMAC5 int SOAP_FMAC6 __ns1__query(struct soap*, ns1__query *ns1__query_, ns1__queryResponse &ns1__queryResponse_);

SOAP_FMAC5 int SOAP_FMAC6 __ns1__write_(struct soap*, ns1__write *ns1__write_, ns1__writeResponse &ns1__writeResponse_);

SOAP_FMAC5 int SOAP_FMAC6 __ns1__query_(struct soap*, ns1__query *ns1__query_, ns1__queryResponse &ns1__queryResponse_);
