...
// DROBDT.h : PROJECT_NAME 应用程序的主头文件
//
...
class CDROBDTApp : public CWinApp
{
public:
	CDROBDTApp();
...
public:
	...
	CStringW m_strIP;
	CStringW m_strPost;
	CStringW m_strDeviceSN;
	CStringW m_strOperatorName;
	CStringW m_strOperatorPassword;
