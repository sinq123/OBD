...
* All rights reserved.
*
* 文件名称：MingQuanMQW511.h
* 文件标识：
* 摘要：鸣泉分析仪MQW511通讯类，继承于抽象类CAna
*
* 当前版本：1.0.0
* 作者：Raylee
* 完成日期：2012-10-11
...
* 作者：Lihy
* 日期：2013-06-19
* 描述：由于没有反吹命令提供,所以用开泵命令来代替(主要方便在设备准备时，仪器调零有动作,用于河北青县版)
*
* 版本：1.0.0
* 作者：Raylee
* 日期：2012-10-11
...
#ifndef MINGQUAN_MQW511_H
#define MINGQUAN_MQW511_H

#include "Ana.h"

class CMingQuanMQW511 : public CAna
{
public:
	CMingQuanMQW511(void);
	~CMingQuanMQW511(void);
...
public:
	...
	DWORD GetProcessDataStatus_CT_Flowmeter(const WORD wCntStart,
		...
		float *const pfBenchO2=NULL, 
		short *const psGasTemp=NULL, 
		float *const pfGasFluxStd=NULL, 
		float *const pfExhaustFlux=NULL, 
		float *const pfGasPres=NULL, 
		float *const pfGasFluxAct=NULL, 
		USHORT *const pusRpm=NULL,
		WORD *const pwMiniStatus=NULL,
