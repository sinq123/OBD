...
CNanhuaNha610Encrypt::CNanhuaNha610Encrypt(void)
...
// 打开串口
DWORD CNanhuaNha610Encrypt::Open(BYTE bPort)
{
	// 关闭已存在的串口句柄
	Close();
...
// 关闭串口
DWORD CNanhuaNha610Encrypt::Close(void)
{
	if (NULL != m_unTimerID)
	{
...
bool CNanhuaNha610Encrypt::IsOpen(void) const
{
	return m_hComm != INVALID_HANDLE_VALUE;
}

DWORD CNanhuaNha610Encrypt::WriteAndReadData(BYTE *const pbWriteBuffer, 
...
BYTE CNanhuaNha610Encrypt::CheckSum(const BYTE *const pb, const UINT un)
{
...
DWORD CNanhuaNha610Encrypt::WriteAndReadData_Flowmeter(BYTE *const pbWriteBuffer, 
												 const DWORD dwWriteLength, 
												 BYTE *const pbReadBuffer, 
												 const DWORD dwReadLength, 
												 const bool bNeedWriteChkSum, 
...
WORD CNanhuaNha610Encrypt::CheckSum_Flowmeter(const BYTE *const pb, const UINT un)
{
	assert(NULL != pb);
	assert(0 != un);
...
DWORD CNanhuaNha610Encrypt::CmdFormat_OnlyReturn06(const BYTE bCmd, BYTE *const pbResult)
{
	BYTE bWriteBuf = bCmd;
	BYTE bReadBuf(0);
...
DWORD CNanhuaNha610Encrypt::CmdFormat_Return00_01_05(const BYTE bCmd, BYTE *const pbResult)
{
	BYTE bWriteBuf = bCmd;
	BYTE bReadBuf(0);
	DWORD dw = WriteAndReadData(&bWriteBuf, 1, &bReadBuf, 1, false, false, true);
...
DWORD CNanhuaNha610Encrypt::CmdFormat_Return00_01_05(const BYTE bCmd, BYTE *const pbResult, short *const psHC, float *const pfCO, float *const pfCO2, float *const pfO2, short *const psNO, float *const pfPef)
{
...
DWORD CNanhuaNha610Encrypt::CmdFormat_Return06_00_01(const BYTE bCmd, BYTE *const pbResult, const USHORT usC3H8, const float fCO, const float fCO2, const USHORT usNO)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha610Encrypt::CmdFormat_Return06_00_01(const BYTE bCmd, BYTE *const pbResult, const float fValue)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha610Encrypt::CmdFormat_Return00_01(const BYTE bCmd, BYTE *const pbResult, const USHORT usC3H8, const float fCO, const float fCO2, const USHORT usNO)
{
	assert(NULL != pbResult);
	assert(usC3H8 >= 0);
	assert(fCO >= 0.0f);
...
DWORD CNanhuaNha610Encrypt::CmdFormat_Return00_01_02(const BYTE bCmd, BYTE *const pbResult, const float fValue)
{
	assert(NULL != pbResult);
...
// 1取主数据
DWORD CNanhuaNha610Encrypt::GetMajorData(short *const psHC, 
							float *const pfCO, 
							float *const pfCO2, 
							float *const pfO2, 
							short *const psNO,
...
DWORD CNanhuaNha610Encrypt::GetNOxData(short *const psHC, 
		float *const pfCO, 
		float *const pfCO2, 
		float *const pfO2, 
		short *const psNO, 
...
DWORD CNanhuaNha610Encrypt::GetMinorData(float *const pfET, float *const pfAP, float *const pfRH)
{
	assert(NULL != pfET);
	assert(NULL != pfAP);
	assert(NULL != pfRH);
...
// 3抽空气
DWORD CNanhuaNha610Encrypt::DeflateEnvAir(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(0x22, pbResult);
}

// 4抽管道气(开泵,气样从探头进入)
DWORD CNanhuaNha610Encrypt::DeflatePipeAir(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(0x23, pbResult);
}

// 5清洗管道(反吹)
DWORD CNanhuaNha610Encrypt::InverseBlow(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(0x05, pbResult);
}

// 6停止清洗(停止反吹及停泵)
DWORD CNanhuaNha610Encrypt::StopPump(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(0x06, pbResult);
}

// 7检漏
DWORD CNanhuaNha610Encrypt::CheckLeak(BYTE *const pbResult)
{
	return CmdFormat_Return00_01_05(0x07, pbResult);
}

// 8调零
DWORD CNanhuaNha610Encrypt::Zero(BYTE *const pbResult)
{
	return CmdFormat_Return00_01_05(0x08, pbResult);
}

// 9写入校准气浓度
DWORD CNanhuaNha610Encrypt::SetCalibrationGasConcentration(BYTE *const pbResult, const int nPoint, 
...
// 10校准
DWORD CNanhuaNha610Encrypt::GasCalibration(BYTE *const pbResult, const int nChanel, 
							  short *const psHC, 
							  float *const pfCO, 
							  float *const pfCO2, 
							  float *const pfO2, 
...
DWORD CNanhuaNha610Encrypt::SetCalibrationNO2Concentration(BYTE *const pbResult, const USHORT usNO2)
{
	return SetCalibrationGasConcentration(pbResult, 0x04, 0, 0.0f, 0.0f, 0, usNO2);
}

DWORD CNanhuaNha610Encrypt::NO2Calibration(BYTE *const pbResult, short *const psNO2/*=NULL*/)
{
	BYTE bWriteBuf = 0xB8;
	BYTE bReadBuf(0);
	DWORD dw = WriteAndReadData(&bWriteBuf, 1, &bReadBuf, 1, false, false, true);
...
// 11写入检查气浓度
DWORD CNanhuaNha610Encrypt::SetCheckGasConcentration(BYTE *const pbResult, const USHORT usChkC3H8, const float fChkCO, const float fChkCO2, const USHORT usChkNO)
{
	return CmdFormat_Return00_01(36, pbResult, usChkC3H8, fChkCO, fChkCO2, usChkNO);
}

// 12自动检查
DWORD CNanhuaNha610Encrypt::GasCheck(BYTE *const pbResult, 
						short *const psHC, 
						float *const pfCO, 
						float *const pfCO2, 
						float *const pfO2, 
...
// 13取PEF
DWORD CNanhuaNha610Encrypt::GetPef(float *const pfPef)
{
	assert(NULL != pfPef);
...
// 14清除NO老化标志
// 503特有
DWORD CNanhuaNha610Encrypt::ClearNoSign(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(14, pbResult);
}

// 15设置调零气体为空气
DWORD CNanhuaNha610Encrypt::SetZeroAirTypeToEnvAir(BYTE *const pbResult)
{
...
// 16设置调零气体为零气
DWORD CNanhuaNha610Encrypt::SetZeroAirTypeToZeroAir(BYTE *const pbResult)
{
...
// 17设置冲程为4
DWORD CNanhuaNha610Encrypt::SetStrokeTypeToFourStroke(BYTE *const pbResult)
{
...
// 18设置冲程为2
DWORD CNanhuaNha610Encrypt::SetStrokeTypeToTwoStroke(BYTE *const pbResult)
{
...
// 19设置点火方式为单次
DWORD CNanhuaNha610Encrypt::SetFireTypeToSingleFire(BYTE *const pbResult)
{
...
// 20设置点火方式为二次
DWORD CNanhuaNha610Encrypt::SetFireTypeToDoubleFire(BYTE *const pbResult)
{
...
// 21允许自动调零
DWORD CNanhuaNha610Encrypt::EnableAutoZero(BYTE *const pbResult)
{
...
// 22禁止自动调零
DWORD CNanhuaNha610Encrypt::DisableAutoZero(BYTE *const pbResult)
{
...
// 27环境温度校准
DWORD CNanhuaNha610Encrypt::ETCalibration(BYTE *const pbResult, const float fCalET)
{
	//assert(NULL != pbResult);
...
// 29油温校准
DWORD CNanhuaNha610Encrypt::OTCalibration(BYTE *const pbResult, const float fCalOT)
{
	//assert(NULL != pbResult);
...
// 30环境湿度校准
DWORD CNanhuaNha610Encrypt::RHCalibration(BYTE *const pbResult, const float fCalRH)
{
	//assert(NULL != pbResult);
...
// 31大气压力校准
DWORD CNanhuaNha610Encrypt::APCalibration(BYTE *const pbResult, const float fCalAP)
{
	//assert(NULL != pbResult);
...
// 32检查气开
DWORD CNanhuaNha610Encrypt::OpenCheckGas(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(0x20, pbResult);
}

// 33检查气关
DWORD CNanhuaNha610Encrypt::CloseCheckGas(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(0x21, pbResult);
}

// 34取仪器状态
DWORD CNanhuaNha610Encrypt::GetStatus(BYTE *const pbStatus)
{
...
DWORD CNanhuaNha610Encrypt::Authentication(void)
{
	::EnterCriticalSection(&cInfoSection);
	if(IsOpen())
	{
...
// 35取预热剩余时间
DWORD CNanhuaNha610Encrypt::GetWarmUpTimeLeft(USHORT *const pusSecondsLeft)
{
...
// 36设置燃料类型为汽油
DWORD CNanhuaNha610Encrypt::SetFuelTypeToGas(BYTE *const pbResult)
{
...
// 37设置燃料类型为液化石油气
DWORD CNanhuaNha610Encrypt::SetFuelTypeToLPG(BYTE *const pbResult)
{
...
// 38设置燃料类型为天然气
DWORD CNanhuaNha610Encrypt::SetFuelTypeToNG(BYTE *const pbResult)
{
...
// 39设置燃料类型为乙醇汽油
DWORD CNanhuaNha610Encrypt::SetFuelTypeToGasohol(BYTE *const pbResult)
{
...
DWORD CNanhuaNha610Encrypt::SetOperationMode(const enum OperationMode op, BYTE *const pbResult/*=NULL*/)
{
#ifdef _DEBUG
	SYSTEMTIME st;
	GetSystemTime(&st);
...
DWORD CNanhuaNha610Encrypt::GetProcessStatus_Flowmeter(BYTE *const pbResult, WORD *const pwProcessStatus, WORD *const pwProcess)
{
...
DWORD CNanhuaNha610Encrypt::StartCollectData_Flowmeter(const WORD wCollectionTime/*=195*/, WORD *const pwMiniStatus/*=NULL*/, BYTE *const pbResult/*=NULL*/)
{
#ifdef _DEBUG
	SYSTEMTIME st;
	GetSystemTime(&st);
...
DWORD CNanhuaNha610Encrypt::StopCollectData_Flowmeter(WORD *const pwMiniStatus/*=NULL*/, BYTE *const pbResult/*=NULL*/)
{
#ifdef _DEBUG
	SYSTEMTIME st;
	GetSystemTime(&st);
...
DWORD CNanhuaNha610Encrypt::GetProcessDataStatus_WT_Flowmeter(const WORD wCntStart,
...
DWORD CNanhuaNha610Encrypt::GetProcessDataStatus_CT_Flowmeter(const WORD wCntStart,
		const WORD wCntLength,
		short *const psHCct, 
		float *const pfCOct, 
		float *const pfCO2ct, 
...
DWORD CNanhuaNha610Encrypt::GetTotalWeight_Flowmeter(USHORT *const pusHCwt, 
...
DWORD CNanhuaNha610Encrypt::GetCollectedDataNumber_Flowmeter(WORD *const pwCorrectedDataNumber, BYTE *const pbResult/*=NULL*/)
{
...
DWORD CNanhuaNha610Encrypt::GetRealTimeData_Flowmeter(float *const pfFluxStd0, float *const pfFluxStd20, float *const pfFluxAct, float *const pfPres, float *const pfUDilO2, float *const pfGasTemp/*=NULL*/, BYTE *const pbResult/*=NULL*/)
{
	//assert(NULL!=pfFlux);
	//assert(NULL!=pfPres);
...
DWORD CNanhuaNha610Encrypt::GetRealTimeData_Flowmeter_ALL(WORD * const pwStatus0,WORD * const pwStatus1,WORD * const pwStatus2,WORD * const pwStatus3,WORD * const pwStatus4,WORD * const pwStatus5,WORD * const pwStatus6,
...
DWORD CNanhuaNha610Encrypt::SetCalibrationFlux_Flowmeter(BYTE *const pbResult, const enum FluxCalibrationMode cm, const float fCalFlux)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha610Encrypt::FluxCalibration_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult, const enum FluxCalibrationMode cm)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha610Encrypt::SetCalibrationPres_Flowmeter(BYTE *const pbResult, const float fCalPres)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha610Encrypt::PresCalibration_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha610Encrypt::SetCalibrationDilO2_Flowmeter(BYTE *const pbResult, const float fCalDilO2)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha610Encrypt::DilO2Calibration_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha610Encrypt::SetCalibrationDilO2_Flowmeter_High(BYTE *const pbResult, const float fCalDilO2)
{
	assert(NULL != pbResult);
	assert(fCalDilO2>10e-6f && fCalDilO2<100.0f);
...
DWORD CNanhuaNha610Encrypt::DilO2Calibration_Flowmeter_High(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha610Encrypt::SetCalibrationDilO2_Flowmeter_Middle(BYTE *const pbResult, const float fCalDilO2)
{
	assert(NULL != pbResult);
	assert(fCalDilO2>10e-6f && fCalDilO2<100.0f);
...
DWORD CNanhuaNha610Encrypt::DilO2Calibration_Flowmeter_Middle(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha610Encrypt::SetCalibrationDilO2_Flowmeter_Low(BYTE *const pbResult, const float fCalDilO2)
{
	assert(NULL != pbResult);
	assert(fCalDilO2>10e-6f && fCalDilO2<100.0f);
...
DWORD CNanhuaNha610Encrypt::DilO2Calibration_Flowmeter_Low(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha610Encrypt::GetHCCOCO2DelayTime_Flowmeter(BYTE *const pbResult, float *const pfDelayTime)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha610Encrypt::SetHCCOCO2DelayTime_Flowmeter(BYTE *const pbResult, const float fDelayTime)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha610Encrypt::HCCOCO2DelayTime_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha610Encrypt::GetO2DelayTime_Flowmeter(BYTE *const pbResult, float *const pfDelayTime)
{
	assert(NULL != pbResult);
	assert(NULL != pfDelayTime);
...
DWORD CNanhuaNha610Encrypt::SetO2DelayTime_Flowmeter(BYTE *const pbResult, const float fDelayTime)
{
	assert(NULL != pbResult);
	assert(fDelayTime>10e-6f && fDelayTime<100.0f);
...
DWORD CNanhuaNha610Encrypt::O2DelayTime_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha610Encrypt::GetNOxDelayTime_Flowmeter(BYTE *const pbResult, float *const pfDelayTime)
{
	assert(NULL != pbResult);
	assert(NULL != pfDelayTime);
...
DWORD CNanhuaNha610Encrypt::SetNOxDelayTime_Flowmeter(BYTE *const pbResult, const float fDelayTime)
{
	assert(NULL != pbResult);
	assert(fDelayTime>10e-6f && fDelayTime<100.0f);
...
DWORD CNanhuaNha610Encrypt::NOxDelayTime_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha610Encrypt::SatrtGetEnvironmentO2_Flowmeter(void)
{
...
DWORD CNanhuaNha610Encrypt::GetEnvironmentO2_Flowmeter(BYTE *const pbResult, float *const pfEnvO2)
{
#ifdef _DEBUG
	SYSTEMTIME st;
	GetSystemTime(&st);
...
DWORD CNanhuaNha610Encrypt::ReadCalibrationData_Flowmeter(BYTE *const pbResult, const BYTE bCalMode, BYTE *const pbReadBuf, const DWORD dwBytesToRead)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha610Encrypt::RunFan_Flowmeter(const bool bRun, BYTE *const pbResult/*=NULL*/)
{
#ifdef _DEBUG
	SYSTEMTIME st;
	GetSystemTime(&st);
...
// 获取手动检测的数据
DWORD CNanhuaNha610Encrypt::GetTestResultData(short *const psHCHigh/*=NULL*/, 
...
DWORD CNanhuaNha610Encrypt::SetCalibrationTemp_Flowmeter(BYTE *const pbResult, const float fCalTemp)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha610Encrypt::TempCalibration_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
void  CNanhuaNha610Encrypt::TimePro(UINT uID, UINT uMsg, DWORD dwUser, DWORD dw1, DWORD dw2)
{
	CNanhuaNha610Encrypt *pThis = (CNanhuaNha610Encrypt *)dwUser;
