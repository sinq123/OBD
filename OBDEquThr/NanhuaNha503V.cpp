...
CNanhuaNha503V::CNanhuaNha503V(void)
...
// 打开串口
DWORD CNanhuaNha503V::Open(BYTE bPort)
{
	// 关闭已存在的串口句柄
	Close();
...
// 关闭串口
DWORD CNanhuaNha503V::Close(void)
{
	if (IsOpen())
	{
...
bool CNanhuaNha503V::IsOpen(void) const
{
	return m_hComm != INVALID_HANDLE_VALUE;
}

DWORD CNanhuaNha503V::WriteAndReadData(BYTE *const pbWriteBuffer, 
...
BYTE CNanhuaNha503V::CheckSum(const BYTE *const pb, const UINT un)
{
...
DWORD CNanhuaNha503V::WriteAndReadData_Flowmeter(BYTE *const pbWriteBuffer, 
												 const DWORD dwWriteLength, 
												 BYTE *const pbReadBuffer, 
												 const DWORD dwReadLength, 
												 const bool bNeedWriteChkSum, 
...
WORD CNanhuaNha503V::CheckSum_Flowmeter(const BYTE *const pb, const UINT un)
{
	assert(NULL != pb);
	assert(0 != un);
...
DWORD CNanhuaNha503V::CmdFormat_OnlyReturn06(const BYTE bCmd, BYTE *const pbResult)
{
	BYTE bWriteBuf = bCmd;
	BYTE bReadBuf(0);
...
DWORD CNanhuaNha503V::CmdFormat_Return00_01_05(const BYTE bCmd, BYTE *const pbResult)
{
	BYTE bWriteBuf = bCmd;
	BYTE bReadBuf(0);
	DWORD dw = WriteAndReadData(&bWriteBuf, 1, &bReadBuf, 1, false, false, true);
...
DWORD CNanhuaNha503V::CmdFormat_Return00_01_05(const BYTE bCmd, BYTE *const pbResult, short *const psHC, float *const pfCO, float *const pfCO2, float *const pfO2, short *const psNO, float *const pfPef)
{
...
DWORD CNanhuaNha503V::CmdFormat_Return06_00_01(const BYTE bCmd, BYTE *const pbResult, const USHORT usC3H8, const float fCO, const float fCO2, const USHORT usNO)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha503V::CmdFormat_Return06_00_01(const BYTE bCmd, BYTE *const pbResult, const float fValue)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha503V::CmdFormat_Return00_01(const BYTE bCmd, BYTE *const pbResult, const USHORT usC3H8, const float fCO, const float fCO2, const USHORT usNO)
{
	assert(NULL != pbResult);
	assert(usC3H8 >= 0);
	assert(fCO >= 0.0f);
...
DWORD CNanhuaNha503V::CmdFormat_Return00_01_02(const BYTE bCmd, BYTE *const pbResult, const float fValue)
{
	assert(NULL != pbResult);
...
// 1取主数据
DWORD CNanhuaNha503V::GetMajorData(short *const psHC, 
							float *const pfCO, 
							float *const pfCO2, 
							float *const pfO2, 
							short *const psNO,
...
DWORD CNanhuaNha503V::GetMinorData(float *const pfET, float *const pfAP, float *const pfRH)
{
	assert(NULL != pfET);
	assert(NULL != pfAP);
	assert(NULL != pfRH);
...
// 3抽空气
DWORD CNanhuaNha503V::DeflateEnvAir(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(34, pbResult);
}

// 4抽管道气(开泵,气样从探头进入)
DWORD CNanhuaNha503V::DeflatePipeAir(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(35, pbResult);
}

// 5清洗管道(反吹)
DWORD CNanhuaNha503V::InverseBlow(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(5, pbResult);
}

// 6停止清洗(停止反吹及停泵)
DWORD CNanhuaNha503V::StopPump(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(6, pbResult);
}

// 7检漏
DWORD CNanhuaNha503V::CheckLeak(BYTE *const pbResult)
{
	return CmdFormat_Return00_01_05(7, pbResult);
}

// 8调零
DWORD CNanhuaNha503V::Zero(BYTE *const pbResult)
{
	return CmdFormat_Return00_01_05(8, pbResult);
}

// 9写入校准气浓度
DWORD CNanhuaNha503V::SetCalibrationGasConcentration(BYTE *const pbResult, const int nPoint, 
...
// 10校准
DWORD CNanhuaNha503V::GasCalibration(BYTE *const pbResult, const int nChanel,  
							  short *const psHC, 
							  float *const pfCO, 
							  float *const pfCO2, 
							  float *const pfO2, 
...
// 11写入检查气浓度
DWORD CNanhuaNha503V::SetCheckGasConcentration(BYTE *const pbResult, const USHORT usChkC3H8, const float fChkCO, const float fChkCO2, const USHORT usChkNO)
{
	return CmdFormat_Return00_01(36, pbResult, usChkC3H8, fChkCO, fChkCO2, usChkNO);
}

// 12自动检查
DWORD CNanhuaNha503V::GasCheck(BYTE *const pbResult, 
						short *const psHC, 
						float *const pfCO, 
						float *const pfCO2, 
						float *const pfO2, 
...
// 13取PEF
DWORD CNanhuaNha503V::GetPef(float *const pfPef)
{
	assert(NULL != pfPef);
...
// 14清除NO老化标志
// 503特有
DWORD CNanhuaNha503V::ClearNoSign(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(14, pbResult);
}

// 15设置调零气体为空气
DWORD CNanhuaNha503V::SetZeroAirTypeToEnvAir(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(15, pbResult);
}

// 16设置调零气体为零气
DWORD CNanhuaNha503V::SetZeroAirTypeToZeroAir(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(16, pbResult);
}

// 17设置冲程为4
DWORD CNanhuaNha503V::SetStrokeTypeToFourStroke(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(17, pbResult);
}

// 18设置冲程为2
DWORD CNanhuaNha503V::SetStrokeTypeToTwoStroke(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(18, pbResult);
}

// 19设置点火方式为单次
DWORD CNanhuaNha503V::SetFireTypeToSingleFire(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(19, pbResult);
}

// 20设置点火方式为二次
DWORD CNanhuaNha503V::SetFireTypeToDoubleFire(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(20, pbResult);
}

// 21允许自动调零
DWORD CNanhuaNha503V::EnableAutoZero(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(21, pbResult);
}

// 22禁止自动调零
DWORD CNanhuaNha503V::DisableAutoZero(BYTE *const pbResult)
{
...
// 27环境温度校准
DWORD CNanhuaNha503V::ETCalibration(BYTE *const pbResult, const float fCalET)
{
	//assert(NULL != pbResult);
...
// 29油温校准
DWORD CNanhuaNha503V::OTCalibration(BYTE *const pbResult, const float fCalOT)
{
	//assert(NULL != pbResult);
...
// 30环境湿度校准
DWORD CNanhuaNha503V::RHCalibration(BYTE *const pbResult, const float fCalRH)
{
	//assert(NULL != pbResult);
...
// 31大气压力校准
DWORD CNanhuaNha503V::APCalibration(BYTE *const pbResult, const float fCalAP)
{
	//assert(NULL != pbResult);
...
// 32检查气开
DWORD CNanhuaNha503V::OpenCheckGas(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(32, pbResult);
}

// 33检查气关
DWORD CNanhuaNha503V::CloseCheckGas(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(33, pbResult);
}

// 34取仪器状态
DWORD CNanhuaNha503V::GetStatus(BYTE *const pbStatus)
{
...
// 35取预热剩余时间
DWORD CNanhuaNha503V::GetWarmUpTimeLeft(USHORT *const pusSecondsLeft)
{
...
// 36设置燃料类型为汽油
DWORD CNanhuaNha503V::SetFuelTypeToGas(BYTE *const pbResult)
{
...
// 37设置燃料类型为液化石油气
DWORD CNanhuaNha503V::SetFuelTypeToLPG(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(41, pbResult);
}

// 38设置燃料类型为天然气
DWORD CNanhuaNha503V::SetFuelTypeToNG(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(42, pbResult);
}

// 39设置燃料类型为乙醇汽油
DWORD CNanhuaNha503V::SetFuelTypeToGasohol(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(43, pbResult);
}

DWORD CNanhuaNha503V::SetOperationMode(const enum OperationMode op, BYTE *const pbResult/*=NULL*/)
{
//#ifdef _DEBUG
//	SYSTEMTIME st;
//	GetSystemTime(&st);
...
DWORD CNanhuaNha503V::GetProcessStatus_Flowmeter(BYTE *const pbResult, WORD *const pwProcessStatus, WORD *const pwProcess)
{
...
DWORD CNanhuaNha503V::StartCollectData_Flowmeter(const WORD wCollectionTime/*=195*/, WORD *const pwMiniStatus/*=NULL*/, BYTE *const pbResult/*=NULL*/)
{
//#ifdef _DEBUG
//	SYSTEMTIME st;
//	GetSystemTime(&st);
...
DWORD CNanhuaNha503V::StopCollectData_Flowmeter(WORD *const pwMiniStatus/*=NULL*/, BYTE *const pbResult/*=NULL*/)
{
//#ifdef _DEBUG
//	SYSTEMTIME st;
//	GetSystemTime(&st);
...
DWORD CNanhuaNha503V::GetProcessDataStatus_WT_Flowmeter(const WORD wCntStart,
...
DWORD CNanhuaNha503V::GetProcessDataStatus_CT_Flowmeter(const WORD wCntStart,
		const WORD wCntLength,
		short *const psHCct, 
		float *const pfCOct, 
		float *const pfCO2ct, 
...
DWORD CNanhuaNha503V::GetTotalWeight_Flowmeter(USHORT *const pusHCwt, 
...
DWORD CNanhuaNha503V::GetCollectedDataNumber_Flowmeter(WORD *const pwCorrectedDataNumber, BYTE *const pbResult/*=NULL*/)
{
...
DWORD CNanhuaNha503V::GetRealTimeData_Flowmeter(float *const pfFluxStd0, float *const pfFluxStd20, float *const pfFluxAct, float *const pfPres, float *const pfUDilO2, float *const pfGasTemp/*=NULL*/, BYTE *const pbResult/*=NULL*/)
{
	//assert(NULL!=pfFlux);
	//assert(NULL!=pfPres);
...
DWORD CNanhuaNha503V::GetRealTimeData_Flowmeter_ALL(WORD * const pwStatus0,WORD * const pwStatus1,WORD * const pwStatus2,WORD * const pwStatus3,WORD * const pwStatus4,WORD * const pwStatus5,WORD * const pwStatus6,
...
DWORD CNanhuaNha503V::SetCalibrationFlux_Flowmeter(BYTE *const pbResult, const enum FluxCalibrationMode cm, const float fCalFlux)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha503V::FluxCalibration_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult, const enum FluxCalibrationMode cm)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha503V::SetCalibrationPres_Flowmeter(BYTE *const pbResult, const float fCalPres)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha503V::PresCalibration_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha503V::SetCalibrationDilO2_Flowmeter(BYTE *const pbResult, const float fCalDilO2)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha503V::DilO2Calibration_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha503V::SetCalibrationDilO2_Flowmeter_High(BYTE *const pbResult, const float fCalDilO2)
{
	assert(NULL != pbResult);
	assert(fCalDilO2>10e-6f && fCalDilO2<100.0f);
...
DWORD CNanhuaNha503V::DilO2Calibration_Flowmeter_High(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha503V::SetCalibrationDilO2_Flowmeter_Middle(BYTE *const pbResult, const float fCalDilO2)
{
	assert(NULL != pbResult);
	assert(fCalDilO2>10e-6f && fCalDilO2<100.0f);
...
DWORD CNanhuaNha503V::DilO2Calibration_Flowmeter_Middle(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha503V::SetCalibrationDilO2_Flowmeter_Low(BYTE *const pbResult, const float fCalDilO2)
{
	assert(NULL != pbResult);
	assert(fCalDilO2>10e-6f && fCalDilO2<100.0f);
...
DWORD CNanhuaNha503V::DilO2Calibration_Flowmeter_Low(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha503V::GetHCCOCO2DelayTime_Flowmeter(BYTE *const pbResult, float *const pfDelayTime)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha503V::SetHCCOCO2DelayTime_Flowmeter(BYTE *const pbResult, const float fDelayTime)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha503V::HCCOCO2DelayTime_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha503V::GetO2DelayTime_Flowmeter(BYTE *const pbResult, float *const pfDelayTime)
{
	assert(NULL != pbResult);
	assert(NULL != pfDelayTime);
...
DWORD CNanhuaNha503V::SetO2DelayTime_Flowmeter(BYTE *const pbResult, const float fDelayTime)
{
	assert(NULL != pbResult);
	assert(fDelayTime>10e-6f && fDelayTime<100.0f);
...
DWORD CNanhuaNha503V::O2DelayTime_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha503V::GetNOxDelayTime_Flowmeter(BYTE *const pbResult, float *const pfDelayTime)
{
	assert(NULL != pbResult);
	assert(NULL != pfDelayTime);
...
DWORD CNanhuaNha503V::SetNOxDelayTime_Flowmeter(BYTE *const pbResult, const float fDelayTime)
{
	assert(NULL != pbResult);
	assert(fDelayTime>10e-6f && fDelayTime<100.0f);
...
DWORD CNanhuaNha503V::NOxDelayTime_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha503V::SatrtGetEnvironmentO2_Flowmeter(void)
{
...
DWORD CNanhuaNha503V::GetEnvironmentO2_Flowmeter(BYTE *const pbResult, float *const pfEnvO2)
{
//#ifdef _DEBUG
//	SYSTEMTIME st;
//	GetSystemTime(&st);
...
DWORD CNanhuaNha503V::ReadCalibrationData_Flowmeter(BYTE *const pbResult, const BYTE bCalMode, BYTE *const pbReadBuf, const DWORD dwBytesToRead)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha503V::RunFan_Flowmeter(const bool bRun, BYTE *const pbResult/*=NULL*/)
{
//#ifdef _DEBUG
//	SYSTEMTIME st;
//	GetSystemTime(&st);
...
// 获取手动检测的数据
DWORD CNanhuaNha503V::GetTestResultData(short *const psHCHigh/*=NULL*/, 
...
DWORD CNanhuaNha503V::SetCalibrationTemp_Flowmeter(BYTE *const pbResult, const float fCalTemp)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha503V::TempCalibration_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
