...
* All rights reserved.
*
* 文件名称：DigitalThermometer.h
* 文件标识：
* 摘要：数字式参数测量仪实体类(上海菱生电子仪器有限公司生产的DPH-103智能大气压力计)
* 当前版本：1.0.0
* 完成日期：2015-12-11
* 作者：LiangQW
* 描述：正式发布使用
...
*/
#pragma once
#ifndef DIGITALTHERMOMETER_H
#define DIGITALTHERMOMETER_H
#include "Para.h"
class CDigitalThermometer : public CPara
{
public:
	CDigitalThermometer(void);
	~CDigitalThermometer(void);
