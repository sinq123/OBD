...
CNanhuaNha506I::CNanhuaNha506I(void)
...
// 打开串口
DWORD CNanhuaNha506I::Open(BYTE bPort)
{
	// 关闭已存在的串口句柄
	Close();
...
// 关闭串口
DWORD CNanhuaNha506I::Close(void)
{
	if (IsOpen())
	{
...
bool CNanhuaNha506I::IsOpen(void) const
{
	return m_hComm != INVALID_HANDLE_VALUE;
}

DWORD CNanhuaNha506I::WriteAndReadData(BYTE *const pbWriteBuffer, 
...
BYTE CNanhuaNha506I::CheckSum(const BYTE *const pb, const UINT un)
{
...
DWORD CNanhuaNha506I::WriteAndReadData_Flowmeter(BYTE *const pbWriteBuffer, 
												 const DWORD dwWriteLength, 
												 BYTE *const pbReadBuffer, 
												 const DWORD dwReadLength, 
												 const bool bNeedWriteChkSum, 
...
WORD CNanhuaNha506I::CheckSum_Flowmeter(const BYTE *const pb, const UINT un)
{
	assert(NULL != pb);
	assert(0 != un);
...
DWORD CNanhuaNha506I::CmdFormat_OnlyReturn06(const BYTE bCmd, BYTE *const pbResult)
{
	BYTE bWriteBuf = bCmd;
	BYTE bReadBuf(0);
...
DWORD CNanhuaNha506I::CmdFormat_Return00_01_05(const BYTE bCmd, BYTE *const pbResult)
{
	BYTE bWriteBuf = bCmd;
	BYTE bReadBuf(0);
	DWORD dw = WriteAndReadData(&bWriteBuf, 1, &bReadBuf, 1, false, false, true);
...
DWORD CNanhuaNha506I::CmdFormat_Return00_01_05(const BYTE bCmd, BYTE *const pbResult, short *const psHC, float *const pfCO, float *const pfCO2, float *const pfO2, short *const psNO, float *const pfPef)
{
...
DWORD CNanhuaNha506I::CmdFormat_Return06_00_01(const BYTE bCmd, BYTE *const pbResult, const USHORT usC3H8, const float fCO, const float fCO2, const USHORT usNO)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha506I::CmdFormat_Return06_00_01(const BYTE bCmd, BYTE *const pbResult, const float fValue)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha506I::CmdFormat_Return00_01(const BYTE bCmd, BYTE *const pbResult, const USHORT usC3H8, const float fCO, const float fCO2, const USHORT usNO)
{
	assert(NULL != pbResult);
	assert(usC3H8 >= 0);
	assert(fCO >= 0.0f);
...
DWORD CNanhuaNha506I::CmdFormat_Return00_01_02(const BYTE bCmd, BYTE *const pbResult, const float fValue)
{
	assert(NULL != pbResult);
...
// 1取主数据
DWORD CNanhuaNha506I::GetMajorData(short *const psHC, 
							float *const pfCO, 
							float *const pfCO2, 
							float *const pfO2, 
							short *const psNO,
							...
							bool *const pbWaterLevel)
{
	...
	if (ANA_WR_SUCCEED == dw)
	{
		...
		if (NULL != pfOilTemp)
		{
			...
			*pfOilTemp = (short)MAKEWORD(bReadBuf[14], bReadBuf[13]);	// 506_v29I没有放大10倍
		}
		// (8) Flux
		if (NULL != pusFlux)
		{
...
DWORD CNanhuaNha506I::GetMinorData(float *const pfET, float *const pfAP, float *const pfRH)
{
	assert(NULL != pfET);
	assert(NULL != pfAP);
	assert(NULL != pfRH);
...
// 3抽空气
DWORD CNanhuaNha506I::DeflateEnvAir(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(34, pbResult);
}

// 4抽管道气(开泵,气样从探头进入)
DWORD CNanhuaNha506I::DeflatePipeAir(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(35, pbResult);
}

// 5清洗管道(反吹)
DWORD CNanhuaNha506I::InverseBlow(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(5, pbResult);
}

// 6停止清洗(停止反吹及停泵)
DWORD CNanhuaNha506I::StopPump(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(6, pbResult);
}

// 7检漏
DWORD CNanhuaNha506I::CheckLeak(BYTE *const pbResult)
{
	return CmdFormat_Return00_01_05(7, pbResult);
}

// 8调零
DWORD CNanhuaNha506I::Zero(BYTE *const pbResult)
{
	return CmdFormat_Return00_01_05(8, pbResult);
}

// 9写入校准气浓度
DWORD CNanhuaNha506I::SetCalibrationGasConcentration(BYTE *const pbResult, const int nPoint, 
...
// 10校准
DWORD CNanhuaNha506I::GasCalibration(BYTE *const pbResult, const int nChanel,  
							  short *const psHC, 
							  float *const pfCO, 
							  float *const pfCO2, 
							  float *const pfO2, 
...
// 11写入检查气浓度
DWORD CNanhuaNha506I::SetCheckGasConcentration(BYTE *const pbResult, const USHORT usChkC3H8, const float fChkCO, const float fChkCO2, const USHORT usChkNO)
{
	return CmdFormat_Return00_01(36, pbResult, usChkC3H8, fChkCO, fChkCO2, usChkNO);
}

// 12自动检查
DWORD CNanhuaNha506I::GasCheck(BYTE *const pbResult, 
						short *const psHC, 
						float *const pfCO, 
						float *const pfCO2, 
						float *const pfO2, 
...
// 13取PEF
DWORD CNanhuaNha506I::GetPef(float *const pfPef)
{
	assert(NULL != pfPef);
...
// 14清除NO老化标志
// 503特有
DWORD CNanhuaNha506I::ClearNoSign(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(14, pbResult);
}

// 15设置调零气体为空气
DWORD CNanhuaNha506I::SetZeroAirTypeToEnvAir(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(15, pbResult);
}

// 16设置调零气体为零气
DWORD CNanhuaNha506I::SetZeroAirTypeToZeroAir(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(16, pbResult);
}

// 17设置冲程为4
DWORD CNanhuaNha506I::SetStrokeTypeToFourStroke(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(17, pbResult);
}

// 18设置冲程为2
DWORD CNanhuaNha506I::SetStrokeTypeToTwoStroke(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(18, pbResult);
}

// 19设置点火方式为单次
DWORD CNanhuaNha506I::SetFireTypeToSingleFire(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(19, pbResult);
}

// 20设置点火方式为二次
DWORD CNanhuaNha506I::SetFireTypeToDoubleFire(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(20, pbResult);
}

// 21允许自动调零
DWORD CNanhuaNha506I::EnableAutoZero(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(21, pbResult);
}

// 22禁止自动调零
DWORD CNanhuaNha506I::DisableAutoZero(BYTE *const pbResult)
{
...
// 27环境温度校准
DWORD CNanhuaNha506I::ETCalibration(BYTE *const pbResult, const float fCalET)
{
	//assert(NULL != pbResult);
...
// 29油温校准
DWORD CNanhuaNha506I::OTCalibration(BYTE *const pbResult, const float fCalOT)
{
	//assert(NULL != pbResult);
...
// 30环境湿度校准
DWORD CNanhuaNha506I::RHCalibration(BYTE *const pbResult, const float fCalRH)
{
	//assert(NULL != pbResult);
...
// 31大气压力校准
DWORD CNanhuaNha506I::APCalibration(BYTE *const pbResult, const float fCalAP)
{
	//assert(NULL != pbResult);
...
// 32检查气开
DWORD CNanhuaNha506I::OpenCheckGas(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(32, pbResult);
}

// 33检查气关
DWORD CNanhuaNha506I::CloseCheckGas(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(33, pbResult);
}

// 34取仪器状态
DWORD CNanhuaNha506I::GetStatus(BYTE *const pbStatus)
{
...
// 35取预热剩余时间
DWORD CNanhuaNha506I::GetWarmUpTimeLeft(USHORT *const pusSecondsLeft)
{
...
// 36设置燃料类型为汽油
DWORD CNanhuaNha506I::SetFuelTypeToGas(BYTE *const pbResult)
{
...
// 37设置燃料类型为液化石油气
DWORD CNanhuaNha506I::SetFuelTypeToLPG(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(41, pbResult);
}

// 38设置燃料类型为天然气
DWORD CNanhuaNha506I::SetFuelTypeToNG(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(42, pbResult);
}

// 39设置燃料类型为乙醇汽油
DWORD CNanhuaNha506I::SetFuelTypeToGasohol(BYTE *const pbResult)
{
	return CmdFormat_OnlyReturn06(43, pbResult);
}

DWORD CNanhuaNha506I::SetOperationMode(const enum OperationMode op, BYTE *const pbResult/*=NULL*/)
{
//#ifdef _DEBUG
//	SYSTEMTIME st;
//	GetSystemTime(&st);
...
DWORD CNanhuaNha506I::GetProcessStatus_Flowmeter(BYTE *const pbResult, WORD *const pwProcessStatus, WORD *const pwProcess)
{
...
DWORD CNanhuaNha506I::StartCollectData_Flowmeter(const WORD wCollectionTime/*=195*/, WORD *const pwMiniStatus/*=NULL*/, BYTE *const pbResult/*=NULL*/)
{
//#ifdef _DEBUG
//	SYSTEMTIME st;
//	GetSystemTime(&st);
...
DWORD CNanhuaNha506I::StopCollectData_Flowmeter(WORD *const pwMiniStatus/*=NULL*/, BYTE *const pbResult/*=NULL*/)
{
//#ifdef _DEBUG
//	SYSTEMTIME st;
//	GetSystemTime(&st);
...
DWORD CNanhuaNha506I::GetProcessDataStatus_WT_Flowmeter(const WORD wCntStart,
...
DWORD CNanhuaNha506I::GetProcessDataStatus_CT_Flowmeter(const WORD wCntStart,
		const WORD wCntLength,
		short *const psHCct, 
		float *const pfCOct, 
		float *const pfCO2ct, 
...
DWORD CNanhuaNha506I::GetTotalWeight_Flowmeter(USHORT *const pusHCwt, 
...
DWORD CNanhuaNha506I::GetCollectedDataNumber_Flowmeter(WORD *const pwCorrectedDataNumber, BYTE *const pbResult/*=NULL*/)
{
...
DWORD CNanhuaNha506I::GetRealTimeData_Flowmeter(float *const pfFluxStd0, float *const pfFluxStd20, float *const pfFluxAct, float *const pfPres, float *const pfUDilO2, float *const pfGasTemp/*=NULL*/, BYTE *const pbResult/*=NULL*/)
{
	//assert(NULL!=pfFlux);
	//assert(NULL!=pfPres);
...
DWORD CNanhuaNha506I::GetRealTimeData_Flowmeter_ALL(WORD * const pwStatus0,WORD * const pwStatus1,WORD * const pwStatus2,WORD * const pwStatus3,WORD * const pwStatus4,WORD * const pwStatus5,WORD * const pwStatus6,
...
DWORD CNanhuaNha506I::SetCalibrationFlux_Flowmeter(BYTE *const pbResult, const enum FluxCalibrationMode cm, const float fCalFlux)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha506I::FluxCalibration_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult, const enum FluxCalibrationMode cm)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha506I::SetCalibrationPres_Flowmeter(BYTE *const pbResult, const float fCalPres)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha506I::PresCalibration_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha506I::SetCalibrationDilO2_Flowmeter(BYTE *const pbResult, const float fCalDilO2)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha506I::DilO2Calibration_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha506I::SetCalibrationDilO2_Flowmeter_High(BYTE *const pbResult, const float fCalDilO2)
{
	assert(NULL != pbResult);
	assert(fCalDilO2>10e-6f && fCalDilO2<100.0f);
...
DWORD CNanhuaNha506I::DilO2Calibration_Flowmeter_High(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha506I::SetCalibrationDilO2_Flowmeter_Middle(BYTE *const pbResult, const float fCalDilO2)
{
	assert(NULL != pbResult);
	assert(fCalDilO2>10e-6f && fCalDilO2<100.0f);
...
DWORD CNanhuaNha506I::DilO2Calibration_Flowmeter_Middle(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha506I::SetCalibrationDilO2_Flowmeter_Low(BYTE *const pbResult, const float fCalDilO2)
{
	assert(NULL != pbResult);
	assert(fCalDilO2>10e-6f && fCalDilO2<100.0f);
...
DWORD CNanhuaNha506I::DilO2Calibration_Flowmeter_Low(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha506I::GetHCCOCO2DelayTime_Flowmeter(BYTE *const pbResult, float *const pfDelayTime)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha506I::SetHCCOCO2DelayTime_Flowmeter(BYTE *const pbResult, const float fDelayTime)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha506I::HCCOCO2DelayTime_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha506I::GetO2DelayTime_Flowmeter(BYTE *const pbResult, float *const pfDelayTime)
{
	assert(NULL != pbResult);
	assert(NULL != pfDelayTime);
...
DWORD CNanhuaNha506I::SetO2DelayTime_Flowmeter(BYTE *const pbResult, const float fDelayTime)
{
	assert(NULL != pbResult);
	assert(fDelayTime>10e-6f && fDelayTime<100.0f);
...
DWORD CNanhuaNha506I::O2DelayTime_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha506I::GetNOxDelayTime_Flowmeter(BYTE *const pbResult, float *const pfDelayTime)
{
	assert(NULL != pbResult);
	assert(NULL != pfDelayTime);
...
DWORD CNanhuaNha506I::SetNOxDelayTime_Flowmeter(BYTE *const pbResult, const float fDelayTime)
{
	assert(NULL != pbResult);
	assert(fDelayTime>10e-6f && fDelayTime<100.0f);
...
DWORD CNanhuaNha506I::NOxDelayTime_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
...
DWORD CNanhuaNha506I::SatrtGetEnvironmentO2_Flowmeter(void)
{
...
DWORD CNanhuaNha506I::GetEnvironmentO2_Flowmeter(BYTE *const pbResult, float *const pfEnvO2)
{
//#ifdef _DEBUG
//	SYSTEMTIME st;
//	GetSystemTime(&st);
...
DWORD CNanhuaNha506I::ReadCalibrationData_Flowmeter(BYTE *const pbResult, const BYTE bCalMode, BYTE *const pbReadBuf, const DWORD dwBytesToRead)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha506I::RunFan_Flowmeter(const bool bRun, BYTE *const pbResult/*=NULL*/)
{
//#ifdef _DEBUG
//	SYSTEMTIME st;
//	GetSystemTime(&st);
...
// 获取手动检测的数据
DWORD CNanhuaNha506I::GetTestResultData(short *const psHCHigh/*=NULL*/, 
...
DWORD CNanhuaNha506I::SetCalibrationTemp_Flowmeter(BYTE *const pbResult, const float fCalTemp)
{
	assert(NULL != pbResult);
...
DWORD CNanhuaNha506I::TempCalibration_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	assert(NULL != pbResult);
	assert(NULL != pbCalResult);
