...
CMingQuanML100::CMingQuanML100(void)
...
// 打开串口
DWORD CMingQuanML100::Open(BYTE bPort)
{
	// 关闭已存在的串口句柄
	Close();
...
// 关闭串口
DWORD CMingQuanML100::Close(void)
{
	if (IsOpen())
	{
...
bool CMingQuanML100::IsOpen(void) const
{
	return m_hComm != INVALID_HANDLE_VALUE;
}

DWORD CMingQuanML100::WriteAndReadData(BYTE *const pbWriteBuffer, 
...
BYTE CMingQuanML100::CheckSum(const BYTE *const pb, const UINT un)
{
...
DWORD CMingQuanML100::WriteAndReadData_Flowmeter(BYTE *const pbWriteBuffer, 
												 const DWORD dwWriteLength, 
												 BYTE *const pbReadBuffer, 
												 const DWORD dwReadLength, 
												 const bool bNeedWriteChkSum, 
...
WORD CMingQuanML100::CheckSum_Flowmeter(const BYTE *const pb, const UINT un)
{
	assert(NULL != pb);
	assert(0 != un);
...
DWORD CMingQuanML100::CmdFormat_OnlyReturn06(const BYTE bCmd, BYTE *const pbResult)
{
	BYTE bWriteBuf = bCmd;
	BYTE bReadBuf(0);
...
// 适合于发四个指令  回四个指令的
DWORD CMingQuanML100::CmdFormat_Return00_01_05(const BYTE bCmd, BYTE *const pbResult)
{
	BYTE ret(0x00);
...
DWORD CMingQuanML100::CmdFormat_Return00_01_05(const BYTE bCmd, BYTE *const pbResult,const BYTE bType)
{
	BYTE ret(0x00);
...
DWORD CMingQuanML100::CmdFormat_Return00_01_05(const BYTE bCmd, BYTE *const pbResult, short *const psHC, float *const pfCO, float *const pfCO2, float *const pfO2, short *const psNO, float *const pfPef)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::CmdFormat_Return06_00_01(const BYTE bCmd, BYTE *const pbResult, const USHORT usC3H8, const float fCO, const float fCO2, const USHORT usNO)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::CmdFormat_Return06_00_01(const BYTE bCmd, BYTE *const pbResult, const float fValue)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::CmdFormat_Return00_01(const BYTE bCmd, BYTE *const pbResult, const USHORT usC3H8, const float fCO, const float fCO2, const USHORT usNO)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::CmdFormat_Return00_01_02(const BYTE bCmd, BYTE *const pbResult, const float fValue)
{
	BYTE ret(0x00);
...
// 1取主数据
DWORD CMingQuanML100::GetMajorData(short *const psHC, 
							float *const pfCO, 
							float *const pfCO2, 
							float *const pfO2, 
							short *const psNO,
...
DWORD CMingQuanML100::GetNOxData(short *const psHC, 
		float *const pfCO, 
		float *const pfCO2, 
		float *const pfO2, 
		short *const psNO, 
...
DWORD CMingQuanML100::GetMinorData(float *const pfET, float *const pfAP, float *const pfRH)
{
	assert(NULL != pfET);
	assert(NULL != pfAP);
	assert(NULL != pfRH);
...
// 3抽空气
DWORD CMingQuanML100::DeflateEnvAir(BYTE *const pbResult)
{
...
// 4抽管道气(开泵,气样从探头进入)
DWORD CMingQuanML100::DeflatePipeAir(BYTE *const pbResult)
{
...
// 5清洗管道(反吹)
DWORD CMingQuanML100::InverseBlow(BYTE *const pbResult)
{
...
// 6停止清洗(停止反吹及停泵)
DWORD CMingQuanML100::StopPump(BYTE *const pbResult)
{
...
// 7检漏
DWORD CMingQuanML100::CheckLeak(BYTE *const pbResult)
{
	DWORD dw(0x00);
	if (pbResult != NULL)
	{
...
// 8调零
DWORD CMingQuanML100::Zero(BYTE *const pbResult)
{
	DWORD dw(0x00);
	if (pbResult != NULL)
	{
...
// 9写入校准气浓度
DWORD CMingQuanML100::SetCalibrationGasConcentration(BYTE *const pbResult, const int nPoint, 
...
// 10校准
DWORD CMingQuanML100::GasCalibration(BYTE *const pbResult, const int nChanel, 
								short *const psHC, 
								float *const pfCO, 
								float *const pfCO2, 
								float *const pfO2, 
...
// 11写入检查气浓度
DWORD CMingQuanML100::SetCheckGasConcentration(BYTE *const pbResult, const USHORT usChkC3H8, const float fChkCO, const float fChkCO2, const USHORT usChkNO)
{
	return CmdFormat_Return00_01(36, pbResult, usChkC3H8, fChkCO, fChkCO2, usChkNO);
}

// 12自动检查
DWORD CMingQuanML100::GasCheck(BYTE *const pbResult, 
						short *const psHC, 
						float *const pfCO, 
						float *const pfCO2, 
						float *const pfO2, 
...
// 13取PEF
DWORD CMingQuanML100::GetPef(float *const pfPef)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}
...
// 14清除NO老化标志
// 503特有
DWORD CMingQuanML100::ClearNoSign(BYTE *const pbResult)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

// 15设置调零气体为空气
DWORD CMingQuanML100::SetZeroAirTypeToEnvAir(BYTE *const pbResult)
{
...
// 16设置调零气体为零气
DWORD CMingQuanML100::SetZeroAirTypeToZeroAir(BYTE *const pbResult)
{
...
// 17设置冲程为4
DWORD CMingQuanML100::SetStrokeTypeToFourStroke(BYTE *const pbResult)
{
	return CmdFormat_Return00_01_05(0x6E, pbResult,0x01);
}

// 18设置冲程为2
DWORD CMingQuanML100::SetStrokeTypeToTwoStroke(BYTE *const pbResult)
{
	return CmdFormat_Return00_01_05(0x6E, pbResult,0x00);
}
// 19设置点火方式为单次
DWORD CMingQuanML100::SetFireTypeToSingleFire(BYTE *const pbResult)
{
	return CmdFormat_Return00_01_05(0x6D, pbResult,0x00);
}

// 20设置点火方式为二次
DWORD CMingQuanML100::SetFireTypeToDoubleFire(BYTE *const pbResult)
{
	return CmdFormat_Return00_01_05(0x6D, pbResult,0x01);
}

// 21允许自动调零
DWORD CMingQuanML100::EnableAutoZero(BYTE *const pbResult)
{
...
// 22禁止自动调零
DWORD CMingQuanML100::DisableAutoZero(BYTE *const pbResult)
{
...
// 23允许键盘操作
DWORD CMingQuanML100::EnableKeyOperate(BYTE *const pbResult)
{
	return CmdFormat_Return00_01_05(0x6A, pbResult);
}
// 24禁止键盘操作
DWORD CMingQuanML100::DisableKeyOperate(BYTE *const pbResult) 
{
...
// 27环境温度校准
DWORD CMingQuanML100::ETCalibration(BYTE *const pbResult, const float fCalET)
{
...
// 29油温校准
DWORD CMingQuanML100::OTCalibration(BYTE *const pbResult, const float fCalOT)
{
	//assert(NULL != pbResult);
...
// 30环境湿度校准
DWORD CMingQuanML100::RHCalibration(BYTE *const pbResult, const float fCalRH)
{
	//assert(NULL != pbResult);
...
// 31大气压力校准
DWORD CMingQuanML100::APCalibration(BYTE *const pbResult, const float fCalAP)
{
	//assert(NULL != pbResult);
...
// 32检查气开
DWORD CMingQuanML100::OpenCheckGas(BYTE *const pbResult)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

// 33检查气关
DWORD CMingQuanML100::CloseCheckGas(BYTE *const pbResult)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

// 34取仪器状态
DWORD CMingQuanML100::GetStatus(BYTE *const pbStatus)
{
...
// 35取预热剩余时间
DWORD CMingQuanML100::GetWarmUpTimeLeft(USHORT *const pusSecondsLeft)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

// 36设置燃料类型为汽油
DWORD CMingQuanML100::SetFuelTypeToGas(BYTE *const pbResult)
{
...
// 37设置燃料类型为液化石油气
DWORD CMingQuanML100::SetFuelTypeToLPG(BYTE *const pbResult)
{
	return CmdFormat_Return00_01_05(0x6C, pbResult,0x01);
}

// 38设置燃料类型为天然气
DWORD CMingQuanML100::SetFuelTypeToNG(BYTE *const pbResult)
{
	return CmdFormat_Return00_01_05(0x6C, pbResult,0x02);
}

// 39设置燃料类型为乙醇汽油
DWORD CMingQuanML100::SetFuelTypeToGasohol(BYTE *const pbResult)
{
	return CmdFormat_Return00_01_05(0x6C, pbResult);
}

DWORD CMingQuanML100::SetOperationMode(const enum OperationMode op, BYTE *const pbResult/*=NULL*/)
{
	if (pbResult != NULL)
	{
		*pbResult = 0x06;
...
DWORD CMingQuanML100::GetProcessStatus_Flowmeter(BYTE *const pbResult, WORD *const pwProcessStatus, WORD *const pwProcess)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::StartCollectData_Flowmeter(const WORD wCollectionTime/*=195*/, WORD *const pwMiniStatus/*=NULL*/, BYTE *const pbResult/*=NULL*/)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::StopCollectData_Flowmeter(WORD *const pwMiniStatus/*=NULL*/, BYTE *const pbResult/*=NULL*/)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::GetProcessDataStatus_WT_Flowmeter(const WORD wCntStart,
...
//DWORD CMingQuanML100::GetProcessDataStatus_CT_Flowmeter(const WORD wCntStart,
//		const WORD wCntLength,
...
DWORD CMingQuanML100::GetTotalWeight_Flowmeter(USHORT *const pusHCwt, 
...
DWORD CMingQuanML100::GetCollectedDataNumber_Flowmeter(WORD *const pwCorrectedDataNumber, BYTE *const pbResult/*=NULL*/)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

//  非标准状态下全部参数
DWORD CMingQuanML100::GetRealTimeData_Flowmeter(float *const pfFluxStd0, float *const pfFluxStd20, 
...
// 标准状态下全部参数
//DWORD CMingQuanML100::GetRealTimeData_Flowmeter(float *const pfFlux, float *const pfPres, float *const pfUDilO2, float *const pfGasTemp/*=NULL*/, BYTE *const pbResult/*=NULL*/)
//{
//	BYTE ret(0x00);
//
//	BYTE bWriteBuf[4] = {0};
...
DWORD CMingQuanML100::GetRealTimeData_Flowmeter_ALL(WORD * const pwStatus0,WORD * const pwStatus1,WORD * const pwStatus2,WORD * const pwStatus3,WORD * const pwStatus4,WORD * const pwStatus5,WORD * const pwStatus6,
...
DWORD CMingQuanML100::SetCalibrationFlux_Flowmeter(BYTE *const pbResult, const enum FluxCalibrationMode cm, const float fCalFlux)
{
	BYTE ret(0x00);
	BYTE bWriteBuf[6] = {0};
	if( cm == HighFlowCal)
...
DWORD CMingQuanML100::FluxCalibration_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult, const enum FluxCalibrationMode cm)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::SetCalibrationPres_Flowmeter(BYTE *const pbResult, const float fCalPres)
{
	BYTE ret(0x00);
	BYTE bWriteBuf[6] = {0};
...
DWORD CMingQuanML100::PresCalibration_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::SetCalibrationDilO2_Flowmeter(BYTE *const pbResult, const float fCalDilO2)
{
	return SetCalibrationDilO2_Flowmeter_High(pbResult, fCalDilO2);
}

DWORD CMingQuanML100::DilO2Calibration_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	if (NULL != pbResult)
	{
		*pbResult = 0x06;
...
DWORD CMingQuanML100::SetCalibrationDilO2_Flowmeter_High(BYTE *const pbResult, const float fCalDilO2)
{
	BYTE ret(0x00);
	BYTE bWriteBuf[6] = {0};
...
DWORD CMingQuanML100::DilO2Calibration_Flowmeter_High(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::SetCalibrationDilO2_Flowmeter_Middle(BYTE *const pbResult, const float fCalDilO2)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::DilO2Calibration_Flowmeter_Middle(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::SetCalibrationDilO2_Flowmeter_Low(BYTE *const pbResult, const float fCalDilO2)
{
	BYTE ret(0x00);
	BYTE bWriteBuf[6] = {0};
...
DWORD CMingQuanML100::DilO2Calibration_Flowmeter_Low(BYTE *const pbResult, BYTE *const pbCalResult, bool bDataRequestMode)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::GetHCCOCO2DelayTime_Flowmeter(BYTE *const pbResult, float *const pfDelayTime)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::SetHCCOCO2DelayTime_Flowmeter(BYTE *const pbResult, const float fDelayTime)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::HCCOCO2DelayTime_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::GetO2DelayTime_Flowmeter(BYTE *const pbResult, float *const pfDelayTime)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::SetO2DelayTime_Flowmeter(BYTE *const pbResult, const float fDelayTime)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::O2DelayTime_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::GetNOxDelayTime_Flowmeter(BYTE *const pbResult, float *const pfDelayTime)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::SetNOxDelayTime_Flowmeter(BYTE *const pbResult, const float fDelayTime)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::NOxDelayTime_Flowmeter(BYTE *const pbResult, BYTE *const pbCalResult)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::SatrtGetEnvironmentO2_Flowmeter(void)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::GetEnvironmentO2_Flowmeter(BYTE *const pbResult, float *const pfEnvO2)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::ReadCalibrationData_Flowmeter(BYTE *const pbResult, const BYTE bCalMode, BYTE *const pbReadBuf, const DWORD dwBytesToRead)
{
	return ANA_WR_EQUIP_RETURE_0X15;
}

DWORD CMingQuanML100::RunFan_Flowmeter(const bool bRun, BYTE *const pbResult/*=NULL*/)
{
	if (pbResult != NULL)
	{
		*pbResult = 0x06;
...
// 获取手动检测的数据
DWORD CMingQuanML100::GetTestResultData(short *const psHCHigh/*=NULL*/, 
