...
* All rights reserved.
*
* 文件名称：NanhuaNha506I.h
* 文件标识：
* 摘要：分析仪NHA506I通讯类，适用于NHA506,NHA605内部通讯协议设备
* 
*
* 当前版本：1.0.0
* 作者：Raylee
...
* 完成日期：2019-05-08
* 作者：Raylee
* 描述：从NHA503V分支，内部通讯协议，只有油温字段的单位不一样
*
*/

#pragma once

#ifndef NANHUA_NHA506I_H
#define NANHUA_NHA506I_H

#include "Ana.h"

class CNanhuaNha506I : public CAna
{
public:
	CNanhuaNha506I(void);
	~CNanhuaNha506I(void);
