...
* All rights reserved.
*
* 文件名称：MingQuanMAY200.h
* 文件标识：
* 摘要：鸣泉不透光度计MQY-200通讯类，继承于抽象类COpa
*		
*
* 版本：1.0
* 作者：Raylee
...
#ifndef MINGQUAN_MQY200_H
#define MINGQUAN_MQY200_H

#include "Opa.h"

class CMingQuanMQY200 : public COpa
{
public:
	CMingQuanMQY200(void);
	~CMingQuanMQY200(void);
