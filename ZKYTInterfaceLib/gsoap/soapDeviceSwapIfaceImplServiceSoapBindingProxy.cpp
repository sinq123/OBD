...
int DeviceSwapIfaceImplServiceSoapBindingProxy::getSqm(const char *endpoint, const char *soap_action, ns1__getSqm *ns1__getSqm_, ns1__getSqmResponse &ns1__getSqmResponse_)
{	struct soap *soap = this;
	struct __ns1__getSqm soap_tmp___ns1__getSqm;
	if (endpoint)
		soap_endpoint = endpoint;
	if (soap_endpoint == NULL)
		soap_endpoint = "http://172.16.128.6:8118/jk/services/deviceSwap";
	if (soap_action == NULL)
		soap_action = "";
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_tmp___ns1__getSqm.ns1__getSqm_ = ns1__getSqm_;
	soap_serializeheader(soap);
	soap_serialize___ns1__getSqm(soap, &soap_tmp___ns1__getSqm);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___ns1__getSqm(soap, &soap_tmp___ns1__getSqm, "-ns1:getSqm", NULL)
	...
	if (!&ns1__getSqmResponse_)
		return soap_closesock(soap);
	ns1__getSqmResponse_.soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns1__getSqmResponse_.soap_get(soap, "ns1:getSqmResponse", NULL);
	if (soap->error)
...
int DeviceSwapIfaceImplServiceSoapBindingProxy::jdcjk(const char *endpoint, const char *soap_action, ns1__jdcjk *ns1__jdcjk_, ns1__jdcjkResponse &ns1__jdcjkResponse_)
{	struct soap *soap = this;
	struct __ns1__jdcjk soap_tmp___ns1__jdcjk;
	if (endpoint)
		soap_endpoint = endpoint;
	if (soap_endpoint == NULL)
		soap_endpoint = "http://172.16.128.6:8118/jk/services/deviceSwap";
	...
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_tmp___ns1__jdcjk.ns1__jdcjk_ = ns1__jdcjk_;
	soap_serializeheader(soap);
	soap_serialize___ns1__jdcjk(soap, &soap_tmp___ns1__jdcjk);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns1__jdcjk(soap, &soap_tmp___ns1__jdcjk, "-ns1:jdcjk", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_connect(soap, soap_url(soap, soap_endpoint, NULL), soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!&ns1__jdcjkResponse_)
		return soap_closesock(soap);
	ns1__jdcjkResponse_.soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns1__jdcjkResponse_.soap_get(soap, "ns1:jdcjkResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
