...
inline _ns1__Common * soap_new_set__ns1__Common(struct soap *soap, std::wstring *methodName, std::wstring *jsonParam, std::wstring *ResultData, std::wstring *SourceData, std::wstring *SourceDataMS, std::wstring *userName, std::wstring *passWord) { _ns1__Common *_p = soap_instantiate__ns1__Common(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_ns1__Common::methodName = methodName; _p->_ns1__Common::jsonParam = jsonParam; _p->_ns1__Common::ResultData = ResultData; _p->_ns1__Common::SourceData = SourceData; _p->_ns1__Common::SourceDataMS = SourceDataMS; _p->_ns1__Common::userName = userName; _p->_ns1__Common::passWord = passWord; } return _p; }
...
#define SOAP_TYPE_PointerTo_ns1__UploadAppearanceData (19)
#endif
...
#define SOAP_TYPE_PointerTo_ns1__Common (15)
#endif
